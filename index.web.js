...
//# sourceURL=webpack:///multi_./src/index.ts?`)}})})});function fn(t){return{width:Math.ceil(t.width),height:Math.ceil(t.height)}}var Ae=t=>t*Math.PI/180;function Dt(t){return t.constructor.name}function Oi(t){return Array.isArray(t)?"Array":typeof t=="object"?Dt(t):typeof t}function Rt(t,e,n){return Math.min(Math.max(t,e),n)}function Fi(t,e){let n;return(...r)=>{clearTimeout(n),n=setTimeout(()=>t(...r),e)}}var dt=(t,e,n,r)=>(n==="dgr"&&(t=Ae(t),e=Ae(e)),r[0]=Math.cos(t)*Math.sin(e),r[1]=Math.cos(e),r[2]=Math.sin(t)*Math.sin(e),r),ot=(t,e)=>Math.ceil(t/e),Gs=["Bytes","KB","MB","GB","TB","PB","EB","ZB","YB"],dn=(t,e)=>{let n=Gs.indexOf(e),r=Math.floor(Math.pow(1024,n));return t*r};var Gi=async t=>{let e=await fetch(t);if(!e.ok)throw`Could not download mesh file '${t}'`;return e.text()},Ni=async t=>(await fetch(t)).arrayBuffer(),Li=async(t,e,n,r)=>{let i=await fetch(e),o=await createImageBitmap(await i.blob()),a=t.createTexture({label:e,dimension:"2d",size:[o.width,o.height,1],format:n,usage:r});return t.queue.copyExternalImageToTexture({source:o},{texture:a},[o.width,o.height]),a};var Ns=1,Te=4,X=4,Ui=8,zi=Te*2,mr=Te*3,J=Te*4,Rd=X*2,ki=X*4,Bd=Ns*4,oe=Te*16,Vi=1e-6,Hi=.001,hr=3,De=3,Bt=window.Deno!==void 0;var pn=Bt,mn=Bt?"static/models":"models",hn="depth24plus",He="rgba16float",gn="rg16float",gr="r16float",$i=[0,1,0],A={FINAL:0,TILES:1,TILES_PPLL:2,HW_RENDER:3,USED_SLICES:4,DEPTH:5,NORMALS:6,AO:7},Ee={AXIS_X:0,AXIS_Y:1,AXIS_Z:2,NONE:3},xe={DENSITY:0,DENSITY_GRADIENT:1,VELOCITY:2,WIND:3},u={isTest:!1,githubRepoLink:"https://github.com/Scthe/frostbitten-hair-webgpu",loaders:{textFileReader:Gi,binaryFileReader:Ni,createTextureFromFile:Li},increaseStorageMemoryLimits:!0,displayMode:A.FINAL,clearColor:[.2,.2,.2,0],clearNormals:[0,0,0,0],clearAo:[0,0,0,0],background:{color0:at(22,162,188),color1:at(14,103,120),noiseScale:5,gradientStrength:.5},colliderGizmo:{lineLength:.04,lineWidth:.002,hoverPadding:1.5,activeAxis:Ee.NONE,isDragging:!1},drawColliders:!0,camera:{position:{position:[.25,1.6,.6],rotation:[-.4,.1]},projection:{fovDgr:30,near:.01,far:100},rotationSpeed:1,movementSpeed:.5,movementSpeedFaster:3},lightAmbient:{color:[1,1,1],energy:.05},lights:[{posPhi:60,posTheta:20,color:at(255,244,204),energy:.8},{posPhi:100,posTheta:97,color:at(204,249,255),energy:.8},{posPhi:-90,posTheta:30,color:at(255,242,204),energy:.8}],shadows:{showDebugView:!1,debugViewPosition:Bt?[0,0]:[250,0],depthFormat:"depth24plus",textureSize:1024*2,usePCSS:!1,PCF_Radius:3,bias:5e-4,strength:.4,hairFiberWidthMultiplier:1,source:{posPhi:37,posTheta:45,distance:5,target:[0,2,0]}},ao:{textureSizeMul:.5,radius:2,directionOffset:0,falloffStart2:.16,falloffEnd2:4,numDirections:12,numSteps:8,strength:.4},hairFile:"SintelHairOriginal-sintel_hair.16points.tfx",pointsPerStrand:-1,hairRender:{fiberRadius:6e-4,dbgTileModeMaxSegments:370,dbgSlicesModeMaxSlices:50,dbgShowTiles:!1,material:{color0:at(119,43,119),color1:at(76,0,255),specular:.9,weightTT:0,weightTRT:1.4,shift:0,roughness:.3,colorRng:.1,lumaRng:.1,attenuation:30,shadows:.5},shadingPoints:64,tileSize:8,tileDepthBins:32,avgSegmentsPerTile:128,invalidTilesPerSegmentThreshold:64*2,sortBuckets:64,sortBucketSize:16,slicesPerPixel:8,avgFragmentsPerSlice:16,processorCount:64*8,finePassWorkgroupSizeX:1,sliceHeadsMemory:"workgroup",alphaQuadratic:!1,alphaMultipler:1.1,lodRenderPercent:100},hairSimulation:{enabled:!0,deltaTime:1/30,nextFrameResetSimulation:!1,gravity:.03,friction:.3,volumePreservation:3e-5,collisionSphere:[-.18,1.56,.06,.06],collisionSphereInitial:[0,0,0,0],constraints:{constraintIterations:7,stiffnessLengthConstr:1,stiffnessGlobalConstr:.2,globalExtent:.1,globalFade:.75,stiffnessLocalConstr:.3,stiffnessCollisions:1,stiffnessSDF:1},wind:{dirPhi:18,dirTheta:91,strength:0,strengthLull:.75,strengthFrequency:1.8,strengthJitter:.7,phaseOffset:.45,colisionTraceOffset:1.5},physicsForcesGrid:{dims:64,enableUpdates:!0,scale:2,showDebugView:!1,debugSlice:.5,debugValue:xe.DENSITY_GRADIENT,debugAbsValue:!0},sdf:{distanceOffset:-.0015,showDebugView:!1,debugSlice:.5,debugSemitransparent:!0}},colors:{gamma:2.2,ditherStrength:1,exposure:.85}};function at(...t){if(t.length!==3)throw new Error(`Config color value ${JSON.stringify(t)} is invalid`);return t.map(e=>e/255)}var Ye=t=>Array(t).fill(0);function Ls(t,e){let n=new t(e.length);return e.forEach((r,i)=>n[i]=r),n}function Ot(t,e){return e instanceof t?e:Ls(t,e)}var _r=Bt,Us=1024,pt=2,zs=Us*pt,Ft=()=>performance.now(),ks=t=>Ft()-t,_n=class{_profileThisFrame=!1;hasRequiredFeature;queryPool;queryInProgressBuffer;resultsBuffer;currentFrameScopes=[];get enabled(){return this._profileThisFrame&&this.hasRequiredFeature}constructor(e){if(this.hasRequiredFeature=e.features.has("timestamp-query"),!this.hasRequiredFeature||_r){this.queryPool=void 0,this.queryInProgressBuffer=void 0,this.resultsBuffer=void 0;return}this.queryPool=e.createQuerySet({type:"timestamp",count:zs}),this.queryInProgressBuffer=e.createBuffer({label:"profiler-in-progress",size:this.queryPool.count*Ui,usage:GPUBufferUsage.QUERY_RESOLVE|GPUBufferUsage.COPY_SRC}),this.resultsBuffer=e.createBuffer({label:"profiler-results",size:this.queryInProgressBuffer.size,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.MAP_READ})}profileNextFrame(e){this._profileThisFrame=e}beginFrame(){for(;this.currentFrameScopes.length>0;)this.currentFrameScopes.pop()}endFrame(e){if(!this.enabled||_r)return;let n=this.currentFrameScopes.length*pt;e.resolveQuerySet(this.queryPool,0,n,this.queryInProgressBuffer,0),this.resultsBuffer.mapState==="unmapped"&&e.copyBufferToBuffer(this.queryInProgressBuffer,0,this.resultsBuffer,0,this.resultsBuffer.size)}async scheduleRaportIfNeededAsync(e){if(!this.enabled||this.currentFrameScopes.length==0){this._profileThisFrame=!1;return}this._profileThisFrame=!1;let n=this.currentFrameScopes.slice();if(_r){let r=new BigInt64Array,i=this.parseScopeTimers(n,r);e?.(i);return}if(this.resultsBuffer.mapState==="unmapped"){await this.resultsBuffer.mapAsync(GPUMapMode.READ);let r=new BigInt64Array(this.resultsBuffer.getMappedRange()),i=this.parseScopeTimers(n,r);this.resultsBuffer.unmap(),e?.(i)}}parseScopeTimers(e,n){return e.map(([r,i,o],a)=>{let s=0;if(i==="gpu"){let l=n[a*pt],c=n[a*pt+1];s=Number(c-l)*Vi}else s=o;return[r,s]})}createScopeGpu(e){if(!this.enabled)return;let n=this.currentFrameScopes.length;return this.currentFrameScopes.push([e,"gpu",0]),{querySet:this.queryPool,beginningOfPassWriteIndex:n*pt,endOfPassWriteIndex:n*pt+1}}startRegionCpu(e){if(!this.enabled)return;let n=this.currentFrameScopes.length,r=performance.now();return this.currentFrameScopes.push([e,"cpu",r]),n}endRegionCpu(e){if(!this.enabled||e===void 0)return;let n=this.currentFrameScopes[e];if(n){let[r,i,o]=n;n[2]=ks(o)}}};var xr=t=>t&&t.style.display!=="none",st=(t,e="block")=>{t&&(t.style.display=e)},xn=t=>{t&&(t.style.display="none")};var Wi={fps:{hideLabel:!0},ms:{hideLabel:!0},"Camera pos":{},"Camera rot":{},Strands:{},"Points per strand":{},Segments:{},Tiles:{},s0:{categoryName:"Memory"},"Tiles heads":{},"Tiles segments":{},"Slices heads":{}," \\ Per processor":{},"Slices data":{},"Hair FBO":{},"Physics grid":{},s1:{categoryName:"Render"},"Rendered strands":{},"Rendered segments":{}},ji=.95,Vs=1e3,Sr=class{values={};lastRenderedValues={};frameStart=0;deltaTimeMS=0;deltaTimeSmoothMS=void 0;parentEl;lastDOMUpdate=0;constructor(){window&&window.document?(this.parentEl=window.document.getElementById("stats-window"),this.frameStart=Ft(),this.lastDOMUpdate=this.frameStart):this.parentEl=void 0}update(e,n){this.values[e]=n}show=()=>st(this.parentEl);onBeginFrame=()=>{this.frameStart=Ft()};onEndFrame=()=>{let e=Ft();this.deltaTimeMS=e-this.frameStart,this.deltaTimeSmoothMS===void 0?this.deltaTimeSmoothMS=this.deltaTimeMS:this.deltaTimeSmoothMS=this.deltaTimeSmoothMS*ji+this.deltaTimeMS*(1-ji);let n=1/this.deltaTimeMS*1e3;this.update("fps",`${n.toFixed(2)} fps`),this.update("ms",`${this.deltaTimeMS.toFixed(2)}ms`),e-this.lastDOMUpdate>Vs&&(this.lastDOMUpdate=e,setTimeout(this.renderStats,0))};printStats=()=>{let e="  ";console.log("STATS {"),Object.entries(Wi).forEach(([n,r])=>{let i=n;if(r.categoryName)console.log(`%c${e}--- ${r.categoryName} ---`,"color: blue");else{let o=this.values[i];o!=null&&console.log(`%c${e}${i}:`,"color: green",o)}}),console.log("}")};renderStats=()=>{let e=Array.from(this.parentEl.children);Object.entries(Wi).forEach(([n,r])=>{let i=n,o=this.getStatsHtmlEl(e,i,r);if(r.categoryName){o.textContent!==r.categoryName&&(o.innerHTML=r.categoryName),o.classList.add("stats-category-name");return}let a=this.values[i],s=this.lastRenderedValues[i];if(a==s)return;let l=`${i}: ${a}`;r.hideLabel&&(l=String(a)),o.innerHTML=l}),this.lastRenderedValues={...this.values}};getStatsHtmlEl=(e,n,r)=>{let i="data-stats-attr";if(r.el)return r.el;let o=e.find(a=>a.getAttribute(i)===n);return o||(o=document.createElement("p"),o.setAttribute(i,n),this.parentEl.appendChild(o)),r.el=o,o};setElVisible(e,n){n&&!xr(e)&&(st(e),this.lastRenderedValues={}),!n&&xr(e)&&(xn(e),this.lastRenderedValues={})}},k=new Sr;function Se(t,e=0){if(t<=0)return"0 Bytes";let n=["Bytes","KB","MB","GB","TB","PB","EB","ZB","YB"],r=1024,i=Math.floor(Math.log(t)/Math.log(r));return`${(t/Math.pow(r,i)).toFixed(e)} ${n[i]}`}function Sn(t,e=2){if(t===0)return"0";let n=t<0?"-":"";t=Math.abs(t);let r=["","k","m","b"],i=1e3,o=Math.floor(Math.log(t)/Math.log(i)),a=(t/Math.pow(i,o)).toFixed(e);return`${n}${a}${r[o]}`}function vr(t,e,n=2){let r=e>0?t/e*100:0;return`${Sn(t,n)} (${r.toFixed(1)}%)`}var Gt=u.hairRender.tileSize*u.hairRender.tileSize*u.hairRender.slicesPerPixel,Hs=u.hairRender.processorCount,Re=u.hairRender.sliceHeadsMemory,Yi=()=>Re==="workgroup"?Gt*X:0,$s=()=>Re==="workgroup"?u.hairRender.finePassWorkgroupSizeX:Re==="global"?Hs:1,Ws=()=>Re==="workgroup"?"_local_invocation_index":Re==="global"?"processorId":"0u",Xi=`
...
${Xi}
`,Ys=Re==="workgroup"?"workgroup":"private",Xs=Re==="workgroup"?Gt*u.hairRender.finePassWorkgroupSizeX:Gt,qs=(t,e)=>`

var<${Ys}> _hairSliceHeads: array<u32, ${Xs}u>;

${Xi}
`,qi=Re==="global"?js:qs;function Ks(t){let e=Zi();return t.createBuffer({label:"hair-slices-heads",size:Math.max(e,ve),usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST})}function Zs(t){Zi()}var Ki=Re==="global"?Ks:Zs;function Zi(){let{processorCount:t}=u.hairRender,e=t*Gt,n=X,r=e*n,o={global:"VRAM",workgroup:"WKGRP",registers:"REGS"}[Re];return k.update("Slices heads",`${o} ${Se(r)}`),k.update(" \\ Per processor",Se(Gt*n)),r}var ve=256;async function Ji(){try{let t=await navigator.gpu.requestAdapter({powerPreference:"high-performance"}),e=a=>console.error(`WebGPU init error: '${a}'`);if(!t){e("No adapter found. WebGPU seems to be unavailable.");return}let n=t.features.has("timestamp-query"),r=["float32-filterable"];n&&r.push("timestamp-query");let i={};if(u.increaseStorageMemoryLimits){let a=t.limits;Number.isSafeInteger(a.maxStorageBufferBindingSize)&&(i.maxStorageBufferBindingSize=Number(a.maxStorageBufferBindingSize)),Number.isSafeInteger(a.maxBufferSize)&&(i.maxBufferSize=Number(a.maxBufferSize)),i.maxStorageBufferBindingSize||=dn(1024,"MB"),i.maxBufferSize||=dn(1024,"MB")}i.maxComputeWorkgroupStorageSize=Math.max(Yi(),t.limits.maxComputeWorkgroupStorageSize||dn(16,"KB")),i.maxStorageBuffersPerShaderStage=10;let o=await t?.requestDevice({requiredFeatures:r,requiredLimits:i});if(!o){e("Failed to get GPUDevice from the adapter.");return}return o}catch(t){console.error(t);return}}function br(t,e,n,r){let i=t.createBuffer({label:e,size:r.byteLength,usage:n});return t.queue.writeBuffer(i,0,r,0),i}function vn(t,e,n,r=0){let i=Ot(Float32Array,n);return br(t,e,GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST|r,i)}function bn(t,e,n){let r=Ot(Uint32Array,n);return br(t,e,GPUBufferUsage.INDEX|GPUBufferUsage.COPY_DST,r)}function be(t,e,n,r=0){let i=Dt(n);if(![Uint32Array.name,Float32Array.name,Int32Array.name].includes(i))throw new Error(`Invalid data provided to createGPU_StorageBuffer(). Expected TypedArray, got ${i}`);return br(t,e,GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST|r,n)}function Xe(t,e){t.clearBuffer(e,0,e.size)}var ae=ot,pe=t=>t==="read_write"?"atomic<u32>":"u32",Nt=t=>t==="read_write"?"atomic<i32>":"i32",L=(t,e)=>({binding:t,resource:{buffer:e}});var Js=t=>typeof t=="object"&&Dt(t)===GPUTextureView.name,$=t=>{if(!Js(t))throw new Error(`Expected ${GPUTextureView.name}, got ${Oi(t)}`)};var lt={CAMERA_FORWARD:"w",CAMERA_BACK:"s",CAMERA_LEFT:"a",CAMERA_RIGHT:"d",CAMERA_UP:" ",CAMERA_DOWN:"z",CAMERA_GO_FASTER:"shift"},Qs=()=>({directions:{forward:!1,backward:!1,left:!1,right:!1,up:!1,down:!1,goFaster:!1},mouse:{x:0,y:0,dragX:0,dragY:0,touching:!1}});function Qi(t,e){let{directions:n,mouse:r}=Qs(),i=(o,a)=>{switch(o.key.toLowerCase()){case lt.CAMERA_FORWARD:n.forward=a,o.preventDefault(),o.stopPropagation();break;case lt.CAMERA_BACK:n.backward=a,o.preventDefault(),o.stopPropagation();break;case lt.CAMERA_LEFT:n.left=a,o.preventDefault(),o.stopPropagation();break;case lt.CAMERA_RIGHT:n.right=a,o.preventDefault(),o.stopPropagation();break;case lt.CAMERA_UP:n.up=a,o.preventDefault(),o.stopPropagation();break;case lt.CAMERA_DOWN:n.down=a,o.preventDefault(),o.stopPropagation();break;case lt.CAMERA_GO_FASTER:n.goFaster=a,o.preventDefault(),o.stopPropagation();break}};return t.addEventListener("keydown",o=>i(o,!0)),t.addEventListener("keyup",o=>i(o,!1)),e.style.touchAction="pinch-zoom",e.addEventListener("pointerdown",()=>{r.touching=!0}),e.addEventListener("pointerup",()=>{r.touching=!1}),e.addEventListener("pointermove",o=>{r.x=o.clientX,r.y=o.clientY,r.touching&&(r.dragX+=o.movementX,r.dragY+=o.movementY)}),()=>{let o={directions:{...n},mouse:{...r}};return r.dragX=0,r.dragY=0,o}}var Y=1e-6;var U=Float32Array;function el(t){let e=U;return U=t,e}function eo(t=0,e=0){let n=new U(2);return t!==void 0&&(n[0]=t,e!==void 0&&(n[1]=e)),n}var I=Float32Array;function tl(t){let e=I;return I=t,e}function me(t,e,n){let r=new I(3);return t!==void 0&&(r[0]=t,e!==void 0&&(r[1]=e,n!==void 0&&(r[2]=n))),r}var nl=eo;function rl(t,e,n){return n=n||new U(2),n[0]=t,n[1]=e,n}function il(t,e){return e=e||new U(2),e[0]=Math.ceil(t[0]),e[1]=Math.ceil(t[1]),e}function ol(t,e){return e=e||new U(2),e[0]=Math.floor(t[0]),e[1]=Math.floor(t[1]),e}function al(t,e){return e=e||new U(2),e[0]=Math.round(t[0]),e[1]=Math.round(t[1]),e}function sl(t,e=0,n=1,r){return r=r||new U(2),r[0]=Math.min(n,Math.max(e,t[0])),r[1]=Math.min(n,Math.max(e,t[1])),r}function ll(t,e,n){return n=n||new U(2),n[0]=t[0]+e[0],n[1]=t[1]+e[1],n}function cl(t,e,n,r){return r=r||new U(2),r[0]=t[0]+e[0]*n,r[1]=t[1]+e[1]*n,r}function ul(t,e){let n=t[0],r=t[1],i=e[0],o=e[1],a=Math.sqrt(n*n+r*r),s=Math.sqrt(i*i+o*o),l=a*s,c=l&&io(t,e)/l;return Math.acos(c)}function to(t,e,n){return n=n||new U(2),n[0]=t[0]-e[0],n[1]=t[1]-e[1],n}var fl=to;function dl(t,e){return Math.abs(t[0]-e[0])<Y&&Math.abs(t[1]-e[1])<Y}function pl(t,e){return t[0]===e[0]&&t[1]===e[1]}function no(t,e,n,r){return r=r||new U(2),r[0]=t[0]+n*(e[0]-t[0]),r[1]=t[1]+n*(e[1]-t[1]),r}function ml(t,e,n,r){return r=r||new U(2),r[0]=t[0]+n[0]*(e[0]-t[0]),r[1]=t[1]+n[1]*(e[1]-t[1]),r}function hl(t,e,n){return n=n||new U(2),n[0]=Math.max(t[0],e[0]),n[1]=Math.max(t[1],e[1]),n}function gl(t,e,n){return n=n||new U(2),n[0]=Math.min(t[0],e[0]),n[1]=Math.min(t[1],e[1]),n}function wr(t,e,n){return n=n||new U(2),n[0]=t[0]*e,n[1]=t[1]*e,n}var _l=wr;function xl(t,e,n){return n=n||new U(2),n[0]=t[0]/e,n[1]=t[1]/e,n}function ro(t,e){return e=e||new U(2),e[0]=1/t[0],e[1]=1/t[1],e}var Sl=ro;function vl(t,e,n){n=n||new I(3);let r=t[0]*e[1]-t[1]*e[0];return n[0]=0,n[1]=0,n[2]=r,n}function io(t,e){return t[0]*e[0]+t[1]*e[1]}function Pr(t){let e=t[0],n=t[1];return Math.sqrt(e*e+n*n)}var bl=Pr;function oo(t){let e=t[0],n=t[1];return e*e+n*n}var wl=oo;function ao(t,e){let n=t[0]-e[0],r=t[1]-e[1];return Math.sqrt(n*n+r*r)}var Pl=ao;function so(t,e){let n=t[0]-e[0],r=t[1]-e[1];return n*n+r*r}var yl=so;function lo(t,e){e=e||new U(2);let n=t[0],r=t[1],i=Math.sqrt(n*n+r*r);return i>1e-5?(e[0]=n/i,e[1]=r/i):(e[0]=0,e[1]=0),e}function Tl(t,e){return e=e||new U(2),e[0]=-t[0],e[1]=-t[1],e}function yr(t,e){return e=e||new U(2),e[0]=t[0],e[1]=t[1],e}var El=yr;function co(t,e,n){return n=n||new U(2),n[0]=t[0]*e[0],n[1]=t[1]*e[1],n}var Ml=co;function uo(t,e,n){return n=n||new U(2),n[0]=t[0]/e[0],n[1]=t[1]/e[1],n}var Il=uo;function Cl(t=1,e){e=e||new U(2);let n=Math.random()*2*Math.PI;return e[0]=Math.cos(n)*t,e[1]=Math.sin(n)*t,e}function Al(t){return t=t||new U(2),t[0]=0,t[1]=0,t}function Dl(t,e,n){n=n||new U(2);let r=t[0],i=t[1];return n[0]=r*e[0]+i*e[4]+e[12],n[1]=r*e[1]+i*e[5]+e[13],n}function Rl(t,e,n){n=n||new U(2);let r=t[0],i=t[1];return n[0]=e[0]*r+e[4]*i+e[8],n[1]=e[1]*r+e[5]*i+e[9],n}function Bl(t,e,n,r){r=r||new U(2);let i=t[0]-e[0],o=t[1]-e[1],a=Math.sin(n),s=Math.cos(n);return r[0]=i*s-o*a+e[0],r[1]=i*a+o*s+e[1],r}function fo(t,e,n){return n=n||new U(2),lo(t,n),wr(n,e,n)}function Ol(t,e,n){return n=n||new U(2),Pr(t)>e?fo(t,e,n):yr(t,n)}function Fl(t,e,n){return n=n||new U(2),no(t,e,.5,n)}var Tr={__proto__:null,add:ll,addScaled:cl,angle:ul,ceil:il,clamp:sl,clone:El,copy:yr,create:eo,cross:vl,dist:Pl,distSq:yl,distance:ao,distanceSq:so,div:Il,divScalar:xl,divide:uo,dot:io,equals:pl,equalsApproximately:dl,floor:ol,fromValues:nl,inverse:ro,invert:Sl,len:bl,lenSq:wl,length:Pr,lengthSq:oo,lerp:no,lerpV:ml,max:hl,midpoint:Fl,min:gl,mul:Ml,mulScalar:wr,multiply:co,negate:Tl,normalize:lo,random:Cl,rotate:Bl,round:al,scale:_l,set:rl,setDefaultType:el,setLength:fo,sub:fl,subtract:to,transformMat3:Rl,transformMat4:Dl,truncate:Ol,zero:Al};var Gl=new Map([[Float32Array,()=>new Float32Array(12)],[Float64Array,()=>new Float64Array(12)],[Array,()=>new Array(12).fill(0)]]),rp=Gl.get(Float32Array);var Nl=me;function Ll(t,e,n,r){return r=r||new I(3),r[0]=t,r[1]=e,r[2]=n,r}function Ul(t,e){return e=e||new I(3),e[0]=Math.ceil(t[0]),e[1]=Math.ceil(t[1]),e[2]=Math.ceil(t[2]),e}function zl(t,e){return e=e||new I(3),e[0]=Math.floor(t[0]),e[1]=Math.floor(t[1]),e[2]=Math.floor(t[2]),e}function kl(t,e){return e=e||new I(3),e[0]=Math.round(t[0]),e[1]=Math.round(t[1]),e[2]=Math.round(t[2]),e}function Vl(t,e=0,n=1,r){return r=r||new I(3),r[0]=Math.min(n,Math.max(e,t[0])),r[1]=Math.min(n,Math.max(e,t[1])),r[2]=Math.min(n,Math.max(e,t[2])),r}function Hl(t,e,n){return n=n||new I(3),n[0]=t[0]+e[0],n[1]=t[1]+e[1],n[2]=t[2]+e[2],n}function $l(t,e,n,r){return r=r||new I(3),r[0]=t[0]+e[0]*n,r[1]=t[1]+e[1]*n,r[2]=t[2]+e[2]*n,r}function Wl(t,e){let n=t[0],r=t[1],i=t[2],o=e[0],a=e[1],s=e[2],l=Math.sqrt(n*n+r*r+i*i),c=Math.sqrt(o*o+a*a+s*s),d=l*c,f=d&&ho(t,e)/d;return Math.acos(f)}function Lt(t,e,n){return n=n||new I(3),n[0]=t[0]-e[0],n[1]=t[1]-e[1],n[2]=t[2]-e[2],n}var jl=Lt;function Yl(t,e){return Math.abs(t[0]-e[0])<Y&&Math.abs(t[1]-e[1])<Y&&Math.abs(t[2]-e[2])<Y}function Xl(t,e){return t[0]===e[0]&&t[1]===e[1]&&t[2]===e[2]}function po(t,e,n,r){return r=r||new I(3),r[0]=t[0]+n*(e[0]-t[0]),r[1]=t[1]+n*(e[1]-t[1]),r[2]=t[2]+n*(e[2]-t[2]),r}function ql(t,e,n,r){return r=r||new I(3),r[0]=t[0]+n[0]*(e[0]-t[0]),r[1]=t[1]+n[1]*(e[1]-t[1]),r[2]=t[2]+n[2]*(e[2]-t[2]),r}function Kl(t,e,n){return n=n||new I(3),n[0]=Math.max(t[0],e[0]),n[1]=Math.max(t[1],e[1]),n[2]=Math.max(t[2],e[2]),n}function Zl(t,e,n){return n=n||new I(3),n[0]=Math.min(t[0],e[0]),n[1]=Math.min(t[1],e[1]),n[2]=Math.min(t[2],e[2]),n}function Er(t,e,n){return n=n||new I(3),n[0]=t[0]*e,n[1]=t[1]*e,n[2]=t[2]*e,n}var Jl=Er;function Ql(t,e,n){return n=n||new I(3),n[0]=t[0]/e,n[1]=t[1]/e,n[2]=t[2]/e,n}function mo(t,e){return e=e||new I(3),e[0]=1/t[0],e[1]=1/t[1],e[2]=1/t[2],e}var ec=mo;function ct(t,e,n){n=n||new I(3);let r=t[2]*e[0]-t[0]*e[2],i=t[0]*e[1]-t[1]*e[0];return n[0]=t[1]*e[2]-t[2]*e[1],n[1]=r,n[2]=i,n}function ho(t,e){return t[0]*e[0]+t[1]*e[1]+t[2]*e[2]}function Mr(t){let e=t[0],n=t[1],r=t[2];return Math.sqrt(e*e+n*n+r*r)}var tc=Mr;function go(t){let e=t[0],n=t[1],r=t[2];return e*e+n*n+r*r}var nc=go;function _o(t,e){let n=t[0]-e[0],r=t[1]-e[1],i=t[2]-e[2];return Math.sqrt(n*n+r*r+i*i)}var rc=_o;function xo(t,e){let n=t[0]-e[0],r=t[1]-e[1],i=t[2]-e[2];return n*n+r*r+i*i}var ic=xo;function Me(t,e){e=e||new I(3);let n=t[0],r=t[1],i=t[2],o=Math.sqrt(n*n+r*r+i*i);return o>1e-5?(e[0]=n/o,e[1]=r/o,e[2]=i/o):(e[0]=0,e[1]=0,e[2]=0),e}function oc(t,e){return e=e||new I(3),e[0]=-t[0],e[1]=-t[1],e[2]=-t[2],e}function Ir(t,e){return e=e||new I(3),e[0]=t[0],e[1]=t[1],e[2]=t[2],e}var ac=Ir;function So(t,e,n){return n=n||new I(3),n[0]=t[0]*e[0],n[1]=t[1]*e[1],n[2]=t[2]*e[2],n}var sc=So;function vo(t,e,n){return n=n||new I(3),n[0]=t[0]/e[0],n[1]=t[1]/e[1],n[2]=t[2]/e[2],n}var lc=vo;function cc(t=1,e){e=e||new I(3);let n=Math.random()*2*Math.PI,r=Math.random()*2-1,i=Math.sqrt(1-r*r)*t;return e[0]=Math.cos(n)*i,e[1]=Math.sin(n)*i,e[2]=r*t,e}function uc(t){return t=t||new I(3),t[0]=0,t[1]=0,t[2]=0,t}function fc(t,e,n){n=n||new I(3);let r=t[0],i=t[1],o=t[2],a=e[3]*r+e[7]*i+e[11]*o+e[15]||1;return n[0]=(e[0]*r+e[4]*i+e[8]*o+e[12])/a,n[1]=(e[1]*r+e[5]*i+e[9]*o+e[13])/a,n[2]=(e[2]*r+e[6]*i+e[10]*o+e[14])/a,n}function dc(t,e,n){n=n||new I(3);let r=t[0],i=t[1],o=t[2];return n[0]=r*e[0*4+0]+i*e[1*4+0]+o*e[2*4+0],n[1]=r*e[0*4+1]+i*e[1*4+1]+o*e[2*4+1],n[2]=r*e[0*4+2]+i*e[1*4+2]+o*e[2*4+2],n}function pc(t,e,n){n=n||new I(3);let r=t[0],i=t[1],o=t[2];return n[0]=r*e[0]+i*e[4]+o*e[8],n[1]=r*e[1]+i*e[5]+o*e[9],n[2]=r*e[2]+i*e[6]+o*e[10],n}function mc(t,e,n){n=n||new I(3);let r=e[0],i=e[1],o=e[2],a=e[3]*2,s=t[0],l=t[1],c=t[2],d=i*c-o*l,f=o*s-r*c,m=r*l-i*s;return n[0]=s+d*a+(i*m-o*f)*2,n[1]=l+f*a+(o*d-r*m)*2,n[2]=c+m*a+(r*f-i*d)*2,n}function hc(t,e){return e=e||new I(3),e[0]=t[12],e[1]=t[13],e[2]=t[14],e}function gc(t,e,n){n=n||new I(3);let r=e*4;return n[0]=t[r+0],n[1]=t[r+1],n[2]=t[r+2],n}function _c(t,e){e=e||new I(3);let n=t[0],r=t[1],i=t[2],o=t[4],a=t[5],s=t[6],l=t[8],c=t[9],d=t[10];return e[0]=Math.sqrt(n*n+r*r+i*i),e[1]=Math.sqrt(o*o+a*a+s*s),e[2]=Math.sqrt(l*l+c*c+d*d),e}function xc(t,e,n,r){r=r||new I(3);let i=[],o=[];return i[0]=t[0]-e[0],i[1]=t[1]-e[1],i[2]=t[2]-e[2],o[0]=i[0],o[1]=i[1]*Math.cos(n)-i[2]*Math.sin(n),o[2]=i[1]*Math.sin(n)+i[2]*Math.cos(n),r[0]=o[0]+e[0],r[1]=o[1]+e[1],r[2]=o[2]+e[2],r}function Sc(t,e,n,r){r=r||new I(3);let i=[],o=[];return i[0]=t[0]-e[0],i[1]=t[1]-e[1],i[2]=t[2]-e[2],o[0]=i[2]*Math.sin(n)+i[0]*Math.cos(n),o[1]=i[1],o[2]=i[2]*Math.cos(n)-i[0]*Math.sin(n),r[0]=o[0]+e[0],r[1]=o[1]+e[1],r[2]=o[2]+e[2],r}function vc(t,e,n,r){r=r||new I(3);let i=[],o=[];return i[0]=t[0]-e[0],i[1]=t[1]-e[1],i[2]=t[2]-e[2],o[0]=i[0]*Math.cos(n)-i[1]*Math.sin(n),o[1]=i[0]*Math.sin(n)+i[1]*Math.cos(n),o[2]=i[2],r[0]=o[0]+e[0],r[1]=o[1]+e[1],r[2]=o[2]+e[2],r}function bo(t,e,n){return n=n||new I(3),Me(t,n),Er(n,e,n)}function bc(t,e,n){return n=n||new I(3),Mr(t)>e?bo(t,e,n):Ir(t,n)}function wc(t,e,n){return n=n||new I(3),po(t,e,.5,n)}var y={__proto__:null,add:Hl,addScaled:$l,angle:Wl,ceil:Ul,clamp:Vl,clone:ac,copy:Ir,create:me,cross:ct,dist:rc,distSq:ic,distance:_o,distanceSq:xo,div:lc,divScalar:Ql,divide:vo,dot:ho,equals:Xl,equalsApproximately:Yl,floor:zl,fromValues:Nl,getAxis:gc,getScaling:_c,getTranslation:hc,inverse:mo,invert:ec,len:tc,lenSq:nc,length:Mr,lengthSq:go,lerp:po,lerpV:ql,max:Kl,midpoint:wc,min:Zl,mul:sc,mulScalar:Er,multiply:So,negate:oc,normalize:Me,random:cc,rotateX:xc,rotateY:Sc,rotateZ:vc,round:kl,scale:Jl,set:Ll,setDefaultType:tl,setLength:bo,sub:jl,subtract:Lt,transformMat3:pc,transformMat4:fc,transformMat4Upper3x3:dc,transformQuat:mc,truncate:bc,zero:uc},O=Float32Array;function Pc(t){let e=O;return O=t,e}function yc(t,e,n,r,i,o,a,s,l,c,d,f,m,v,b,x){let g=new O(16);return t!==void 0&&(g[0]=t,e!==void 0&&(g[1]=e,n!==void 0&&(g[2]=n,r!==void 0&&(g[3]=r,i!==void 0&&(g[4]=i,o!==void 0&&(g[5]=o,a!==void 0&&(g[6]=a,s!==void 0&&(g[7]=s,l!==void 0&&(g[8]=l,c!==void 0&&(g[9]=c,d!==void 0&&(g[10]=d,f!==void 0&&(g[11]=f,m!==void 0&&(g[12]=m,v!==void 0&&(g[13]=v,b!==void 0&&(g[14]=b,x!==void 0&&(g[15]=x)))))))))))))))),g}function Tc(t,e,n,r,i,o,a,s,l,c,d,f,m,v,b,x,g){return g=g||new O(16),g[0]=t,g[1]=e,g[2]=n,g[3]=r,g[4]=i,g[5]=o,g[6]=a,g[7]=s,g[8]=l,g[9]=c,g[10]=d,g[11]=f,g[12]=m,g[13]=v,g[14]=b,g[15]=x,g}function Ec(t,e){return e=e||new O(16),e[0]=t[0],e[1]=t[1],e[2]=t[2],e[3]=0,e[4]=t[4],e[5]=t[5],e[6]=t[6],e[7]=0,e[8]=t[8],e[9]=t[9],e[10]=t[10],e[11]=0,e[12]=0,e[13]=0,e[14]=0,e[15]=1,e}function Mc(t,e){e=e||new O(16);let n=t[0],r=t[1],i=t[2],o=t[3],a=n+n,s=r+r,l=i+i,c=n*a,d=r*a,f=r*s,m=i*a,v=i*s,b=i*l,x=o*a,g=o*s,T=o*l;return e[0]=1-f-b,e[1]=d+T,e[2]=m-g,e[3]=0,e[4]=d-T,e[5]=1-c-b,e[6]=v+x,e[7]=0,e[8]=m+g,e[9]=v-x,e[10]=1-c-f,e[11]=0,e[12]=0,e[13]=0,e[14]=0,e[15]=1,e}function Ic(t,e){return e=e||new O(16),e[0]=-t[0],e[1]=-t[1],e[2]=-t[2],e[3]=-t[3],e[4]=-t[4],e[5]=-t[5],e[6]=-t[6],e[7]=-t[7],e[8]=-t[8],e[9]=-t[9],e[10]=-t[10],e[11]=-t[11],e[12]=-t[12],e[13]=-t[13],e[14]=-t[14],e[15]=-t[15],e}function Cr(t,e){return e=e||new O(16),e[0]=t[0],e[1]=t[1],e[2]=t[2],e[3]=t[3],e[4]=t[4],e[5]=t[5],e[6]=t[6],e[7]=t[7],e[8]=t[8],e[9]=t[9],e[10]=t[10],e[11]=t[11],e[12]=t[12],e[13]=t[13],e[14]=t[14],e[15]=t[15],e}var Cc=Cr;function Ac(t,e){return Math.abs(t[0]-e[0])<Y&&Math.abs(t[1]-e[1])<Y&&Math.abs(t[2]-e[2])<Y&&Math.abs(t[3]-e[3])<Y&&Math.abs(t[4]-e[4])<Y&&Math.abs(t[5]-e[5])<Y&&Math.abs(t[6]-e[6])<Y&&Math.abs(t[7]-e[7])<Y&&Math.abs(t[8]-e[8])<Y&&Math.abs(t[9]-e[9])<Y&&Math.abs(t[10]-e[10])<Y&&Math.abs(t[11]-e[11])<Y&&Math.abs(t[12]-e[12])<Y&&Math.abs(t[13]-e[13])<Y&&Math.abs(t[14]-e[14])<Y&&Math.abs(t[15]-e[15])<Y}function Dc(t,e){return t[0]===e[0]&&t[1]===e[1]&&t[2]===e[2]&&t[3]===e[3]&&t[4]===e[4]&&t[5]===e[5]&&t[6]===e[6]&&t[7]===e[7]&&t[8]===e[8]&&t[9]===e[9]&&t[10]===e[10]&&t[11]===e[11]&&t[12]===e[12]&&t[13]===e[13]&&t[14]===e[14]&&t[15]===e[15]}function wo(t){return t=t||new O(16),t[0]=1,t[1]=0,t[2]=0,t[3]=0,t[4]=0,t[5]=1,t[6]=0,t[7]=0,t[8]=0,t[9]=0,t[10]=1,t[11]=0,t[12]=0,t[13]=0,t[14]=0,t[15]=1,t}function Rc(t,e){if(e=e||new O(16),e===t){let P;return P=t[1],t[1]=t[4],t[4]=P,P=t[2],t[2]=t[8],t[8]=P,P=t[3],t[3]=t[12],t[12]=P,P=t[6],t[6]=t[9],t[9]=P,P=t[7],t[7]=t[13],t[13]=P,P=t[11],t[11]=t[14],t[14]=P,e}let n=t[0*4+0],r=t[0*4+1],i=t[0*4+2],o=t[0*4+3],a=t[1*4+0],s=t[1*4+1],l=t[1*4+2],c=t[1*4+3],d=t[2*4+0],f=t[2*4+1],m=t[2*4+2],v=t[2*4+3],b=t[3*4+0],x=t[3*4+1],g=t[3*4+2],T=t[3*4+3];return e[0]=n,e[1]=a,e[2]=d,e[3]=b,e[4]=r,e[5]=s,e[6]=f,e[7]=x,e[8]=i,e[9]=l,e[10]=m,e[11]=g,e[12]=o,e[13]=c,e[14]=v,e[15]=T,e}function Po(t,e){e=e||new O(16);let n=t[0*4+0],r=t[0*4+1],i=t[0*4+2],o=t[0*4+3],a=t[1*4+0],s=t[1*4+1],l=t[1*4+2],c=t[1*4+3],d=t[2*4+0],f=t[2*4+1],m=t[2*4+2],v=t[2*4+3],b=t[3*4+0],x=t[3*4+1],g=t[3*4+2],T=t[3*4+3],P=m*T,_=g*v,S=l*T,E=g*c,N=l*v,R=m*c,V=i*T,w=g*o,Q=i*v,ne=m*o,re=i*c,ce=l*o,ue=d*x,fe=b*f,de=a*x,ge=b*s,_e=a*f,rn=d*s,on=n*x,an=b*r,sn=n*f,ln=d*r,cn=n*s,un=a*r,Ci=P*s+E*f+N*x-(_*s+S*f+R*x),Ai=_*r+V*f+ne*x-(P*r+w*f+Q*x),Di=S*r+w*s+re*x-(E*r+V*s+ce*x),Ri=R*r+Q*s+ce*f-(N*r+ne*s+re*f),ie=1/(n*Ci+a*Ai+d*Di+b*Ri);return e[0]=ie*Ci,e[1]=ie*Ai,e[2]=ie*Di,e[3]=ie*Ri,e[4]=ie*(_*a+S*d+R*b-(P*a+E*d+N*b)),e[5]=ie*(P*n+w*d+Q*b-(_*n+V*d+ne*b)),e[6]=ie*(E*n+V*a+ce*b-(S*n+w*a+re*b)),e[7]=ie*(N*n+ne*a+re*d-(R*n+Q*a+ce*d)),e[8]=ie*(ue*c+ge*v+_e*T-(fe*c+de*v+rn*T)),e[9]=ie*(fe*o+on*v+ln*T-(ue*o+an*v+sn*T)),e[10]=ie*(de*o+an*c+cn*T-(ge*o+on*c+un*T)),e[11]=ie*(rn*o+sn*c+un*v-(_e*o+ln*c+cn*v)),e[12]=ie*(de*m+rn*g+fe*l-(_e*g+ue*l+ge*m)),e[13]=ie*(sn*g+ue*i+an*m-(on*m+ln*g+fe*i)),e[14]=ie*(on*l+un*g+ge*i-(cn*g+de*i+an*l)),e[15]=ie*(cn*m+_e*i+ln*l-(sn*l+un*m+rn*i)),e}function Bc(t){let e=t[0],n=t[0*4+1],r=t[0*4+2],i=t[0*4+3],o=t[1*4+0],a=t[1*4+1],s=t[1*4+2],l=t[1*4+3],c=t[2*4+0],d=t[2*4+1],f=t[2*4+2],m=t[2*4+3],v=t[3*4+0],b=t[3*4+1],x=t[3*4+2],g=t[3*4+3],T=f*g,P=x*m,_=s*g,S=x*l,E=s*m,N=f*l,R=r*g,V=x*i,w=r*m,Q=f*i,ne=r*l,re=s*i,ce=T*a+S*d+E*b-(P*a+_*d+N*b),ue=P*n+R*d+Q*b-(T*n+V*d+w*b),fe=_*n+V*a+ne*b-(S*n+R*a+re*b),de=N*n+w*a+re*d-(E*n+Q*a+ne*d);return e*ce+o*ue+c*fe+v*de}var Oc=Po;function yo(t,e,n){n=n||new O(16);let r=t[0],i=t[1],o=t[2],a=t[3],s=t[4],l=t[5],c=t[6],d=t[7],f=t[8],m=t[9],v=t[10],b=t[11],x=t[12],g=t[13],T=t[14],P=t[15],_=e[0],S=e[1],E=e[2],N=e[3],R=e[4],V=e[5],w=e[6],Q=e[7],ne=e[8],re=e[9],ce=e[10],ue=e[11],fe=e[12],de=e[13],ge=e[14],_e=e[15];return n[0]=r*_+s*S+f*E+x*N,n[1]=i*_+l*S+m*E+g*N,n[2]=o*_+c*S+v*E+T*N,n[3]=a*_+d*S+b*E+P*N,n[4]=r*R+s*V+f*w+x*Q,n[5]=i*R+l*V+m*w+g*Q,n[6]=o*R+c*V+v*w+T*Q,n[7]=a*R+d*V+b*w+P*Q,n[8]=r*ne+s*re+f*ce+x*ue,n[9]=i*ne+l*re+m*ce+g*ue,n[10]=o*ne+c*re+v*ce+T*ue,n[11]=a*ne+d*re+b*ce+P*ue,n[12]=r*fe+s*de+f*ge+x*_e,n[13]=i*fe+l*de+m*ge+g*_e,n[14]=o*fe+c*de+v*ge+T*_e,n[15]=a*fe+d*de+b*ge+P*_e,n}var Fc=yo;function Gc(t,e,n){return n=n||wo(),t!==n&&(n[0]=t[0],n[1]=t[1],n[2]=t[2],n[3]=t[3],n[4]=t[4],n[5]=t[5],n[6]=t[6],n[7]=t[7],n[8]=t[8],n[9]=t[9],n[10]=t[10],n[11]=t[11]),n[12]=e[0],n[13]=e[1],n[14]=e[2],n[15]=1,n}function Nc(t,e){return e=e||me(),e[0]=t[12],e[1]=t[13],e[2]=t[14],e}function Lc(t,e,n){n=n||me();let r=e*4;return n[0]=t[r+0],n[1]=t[r+1],n[2]=t[r+2],n}function Uc(t,e,n,r){r!==t&&(r=Cr(t,r));let i=n*4;return r[i+0]=e[0],r[i+1]=e[1],r[i+2]=e[2],r}function zc(t,e){e=e||me();let n=t[0],r=t[1],i=t[2],o=t[4],a=t[5],s=t[6],l=t[8],c=t[9],d=t[10];return e[0]=Math.sqrt(n*n+r*r+i*i),e[1]=Math.sqrt(o*o+a*a+s*s),e[2]=Math.sqrt(l*l+c*c+d*d),e}function kc(t,e,n,r,i){i=i||new O(16);let o=Math.tan(Math.PI*.5-.5*t);if(i[0]=o/e,i[1]=0,i[2]=0,i[3]=0,i[4]=0,i[5]=o,i[6]=0,i[7]=0,i[8]=0,i[9]=0,i[11]=-1,i[12]=0,i[13]=0,i[15]=0,Number.isFinite(r)){let a=1/(n-r);i[10]=r*a,i[14]=r*n*a}else i[10]=-1,i[14]=-n;return i}function Vc(t,e,n,r=1/0,i){i=i||new O(16);let o=1/Math.tan(t*.5);if(i[0]=o/e,i[1]=0,i[2]=0,i[3]=0,i[4]=0,i[5]=o,i[6]=0,i[7]=0,i[8]=0,i[9]=0,i[11]=-1,i[12]=0,i[13]=0,i[15]=0,r===1/0)i[10]=0,i[14]=n;else{let a=1/(r-n);i[10]=n*a,i[14]=r*n*a}return i}function Hc(t,e,n,r,i,o,a){return a=a||new O(16),a[0]=2/(e-t),a[1]=0,a[2]=0,a[3]=0,a[4]=0,a[5]=2/(r-n),a[6]=0,a[7]=0,a[8]=0,a[9]=0,a[10]=1/(i-o),a[11]=0,a[12]=(e+t)/(t-e),a[13]=(r+n)/(n-r),a[14]=i/(i-o),a[15]=1,a}function $c(t,e,n,r,i,o,a){a=a||new O(16);let s=e-t,l=r-n,c=i-o;return a[0]=2*i/s,a[1]=0,a[2]=0,a[3]=0,a[4]=0,a[5]=2*i/l,a[6]=0,a[7]=0,a[8]=(t+e)/s,a[9]=(r+n)/l,a[10]=o/c,a[11]=-1,a[12]=0,a[13]=0,a[14]=i*o/c,a[15]=0,a}function Wc(t,e,n,r,i,o=1/0,a){a=a||new O(16);let s=e-t,l=r-n;if(a[0]=2*i/s,a[1]=0,a[2]=0,a[3]=0,a[4]=0,a[5]=2*i/l,a[6]=0,a[7]=0,a[8]=(t+e)/s,a[9]=(r+n)/l,a[11]=-1,a[12]=0,a[13]=0,a[15]=0,o===1/0)a[10]=0,a[14]=i;else{let c=1/(o-i);a[10]=i*c,a[14]=o*i*c}return a}var W,q,z;function jc(t,e,n,r){return r=r||new O(16),W=W||me(),q=q||me(),z=z||me(),Me(Lt(e,t,z),z),Me(ct(n,z,W),W),Me(ct(z,W,q),q),r[0]=W[0],r[1]=W[1],r[2]=W[2],r[3]=0,r[4]=q[0],r[5]=q[1],r[6]=q[2],r[7]=0,r[8]=z[0],r[9]=z[1],r[10]=z[2],r[11]=0,r[12]=t[0],r[13]=t[1],r[14]=t[2],r[15]=1,r}function Yc(t,e,n,r){return r=r||new O(16),W=W||me(),q=q||me(),z=z||me(),Me(Lt(t,e,z),z),Me(ct(n,z,W),W),Me(ct(z,W,q),q),r[0]=W[0],r[1]=W[1],r[2]=W[2],r[3]=0,r[4]=q[0],r[5]=q[1],r[6]=q[2],r[7]=0,r[8]=z[0],r[9]=z[1],r[10]=z[2],r[11]=0,r[12]=t[0],r[13]=t[1],r[14]=t[2],r[15]=1,r}function Xc(t,e,n,r){return r=r||new O(16),W=W||me(),q=q||me(),z=z||me(),Me(Lt(t,e,z),z),Me(ct(n,z,W),W),Me(ct(z,W,q),q),r[0]=W[0],r[1]=q[0],r[2]=z[0],r[3]=0,r[4]=W[1],r[5]=q[1],r[6]=z[1],r[7]=0,r[8]=W[2],r[9]=q[2],r[10]=z[2],r[11]=0,r[12]=-(W[0]*t[0]+W[1]*t[1]+W[2]*t[2]),r[13]=-(q[0]*t[0]+q[1]*t[1]+q[2]*t[2]),r[14]=-(z[0]*t[0]+z[1]*t[1]+z[2]*t[2]),r[15]=1,r}function qc(t,e){return e=e||new O(16),e[0]=1,e[1]=0,e[2]=0,e[3]=0,e[4]=0,e[5]=1,e[6]=0,e[7]=0,e[8]=0,e[9]=0,e[10]=1,e[11]=0,e[12]=t[0],e[13]=t[1],e[14]=t[2],e[15]=1,e}function Kc(t,e,n){n=n||new O(16);let r=e[0],i=e[1],o=e[2],a=t[0],s=t[1],l=t[2],c=t[3],d=t[1*4+0],f=t[1*4+1],m=t[1*4+2],v=t[1*4+3],b=t[2*4+0],x=t[2*4+1],g=t[2*4+2],T=t[2*4+3],P=t[3*4+0],_=t[3*4+1],S=t[3*4+2],E=t[3*4+3];return t!==n&&(n[0]=a,n[1]=s,n[2]=l,n[3]=c,n[4]=d,n[5]=f,n[6]=m,n[7]=v,n[8]=b,n[9]=x,n[10]=g,n[11]=T),n[12]=a*r+d*i+b*o+P,n[13]=s*r+f*i+x*o+_,n[14]=l*r+m*i+g*o+S,n[15]=c*r+v*i+T*o+E,n}function Zc(t,e){e=e||new O(16);let n=Math.cos(t),r=Math.sin(t);return e[0]=1,e[1]=0,e[2]=0,e[3]=0,e[4]=0,e[5]=n,e[6]=r,e[7]=0,e[8]=0,e[9]=-r,e[10]=n,e[11]=0,e[12]=0,e[13]=0,e[14]=0,e[15]=1,e}function Jc(t,e,n){n=n||new O(16);let r=t[4],i=t[5],o=t[6],a=t[7],s=t[8],l=t[9],c=t[10],d=t[11],f=Math.cos(e),m=Math.sin(e);return n[4]=f*r+m*s,n[5]=f*i+m*l,n[6]=f*o+m*c,n[7]=f*a+m*d,n[8]=f*s-m*r,n[9]=f*l-m*i,n[10]=f*c-m*o,n[11]=f*d-m*a,t!==n&&(n[0]=t[0],n[1]=t[1],n[2]=t[2],n[3]=t[3],n[12]=t[12],n[13]=t[13],n[14]=t[14],n[15]=t[15]),n}function Qc(t,e){e=e||new O(16);let n=Math.cos(t),r=Math.sin(t);return e[0]=n,e[1]=0,e[2]=-r,e[3]=0,e[4]=0,e[5]=1,e[6]=0,e[7]=0,e[8]=r,e[9]=0,e[10]=n,e[11]=0,e[12]=0,e[13]=0,e[14]=0,e[15]=1,e}function eu(t,e,n){n=n||new O(16);let r=t[0*4+0],i=t[0*4+1],o=t[0*4+2],a=t[0*4+3],s=t[2*4+0],l=t[2*4+1],c=t[2*4+2],d=t[2*4+3],f=Math.cos(e),m=Math.sin(e);return n[0]=f*r-m*s,n[1]=f*i-m*l,n[2]=f*o-m*c,n[3]=f*a-m*d,n[8]=f*s+m*r,n[9]=f*l+m*i,n[10]=f*c+m*o,n[11]=f*d+m*a,t!==n&&(n[4]=t[4],n[5]=t[5],n[6]=t[6],n[7]=t[7],n[12]=t[12],n[13]=t[13],n[14]=t[14],n[15]=t[15]),n}function tu(t,e){e=e||new O(16);let n=Math.cos(t),r=Math.sin(t);return e[0]=n,e[1]=r,e[2]=0,e[3]=0,e[4]=-r,e[5]=n,e[6]=0,e[7]=0,e[8]=0,e[9]=0,e[10]=1,e[11]=0,e[12]=0,e[13]=0,e[14]=0,e[15]=1,e}function nu(t,e,n){n=n||new O(16);let r=t[0*4+0],i=t[0*4+1],o=t[0*4+2],a=t[0*4+3],s=t[1*4+0],l=t[1*4+1],c=t[1*4+2],d=t[1*4+3],f=Math.cos(e),m=Math.sin(e);return n[0]=f*r+m*s,n[1]=f*i+m*l,n[2]=f*o+m*c,n[3]=f*a+m*d,n[4]=f*s-m*r,n[5]=f*l-m*i,n[6]=f*c-m*o,n[7]=f*d-m*a,t!==n&&(n[8]=t[8],n[9]=t[9],n[10]=t[10],n[11]=t[11],n[12]=t[12],n[13]=t[13],n[14]=t[14],n[15]=t[15]),n}function To(t,e,n){n=n||new O(16);let r=t[0],i=t[1],o=t[2],a=Math.sqrt(r*r+i*i+o*o);r/=a,i/=a,o/=a;let s=r*r,l=i*i,c=o*o,d=Math.cos(e),f=Math.sin(e),m=1-d;return n[0]=s+(1-s)*d,n[1]=r*i*m+o*f,n[2]=r*o*m-i*f,n[3]=0,n[4]=r*i*m-o*f,n[5]=l+(1-l)*d,n[6]=i*o*m+r*f,n[7]=0,n[8]=r*o*m+i*f,n[9]=i*o*m-r*f,n[10]=c+(1-c)*d,n[11]=0,n[12]=0,n[13]=0,n[14]=0,n[15]=1,n}var ru=To;function Eo(t,e,n,r){r=r||new O(16);let i=e[0],o=e[1],a=e[2],s=Math.sqrt(i*i+o*o+a*a);i/=s,o/=s,a/=s;let l=i*i,c=o*o,d=a*a,f=Math.cos(n),m=Math.sin(n),v=1-f,b=l+(1-l)*f,x=i*o*v+a*m,g=i*a*v-o*m,T=i*o*v-a*m,P=c+(1-c)*f,_=o*a*v+i*m,S=i*a*v+o*m,E=o*a*v-i*m,N=d+(1-d)*f,R=t[0],V=t[1],w=t[2],Q=t[3],ne=t[4],re=t[5],ce=t[6],ue=t[7],fe=t[8],de=t[9],ge=t[10],_e=t[11];return r[0]=b*R+x*ne+g*fe,r[1]=b*V+x*re+g*de,r[2]=b*w+x*ce+g*ge,r[3]=b*Q+x*ue+g*_e,r[4]=T*R+P*ne+_*fe,r[5]=T*V+P*re+_*de,r[6]=T*w+P*ce+_*ge,r[7]=T*Q+P*ue+_*_e,r[8]=S*R+E*ne+N*fe,r[9]=S*V+E*re+N*de,r[10]=S*w+E*ce+N*ge,r[11]=S*Q+E*ue+N*_e,t!==r&&(r[12]=t[12],r[13]=t[13],r[14]=t[14],r[15]=t[15]),r}var iu=Eo;function ou(t,e){return e=e||new O(16),e[0]=t[0],e[1]=0,e[2]=0,e[3]=0,e[4]=0,e[5]=t[1],e[6]=0,e[7]=0,e[8]=0,e[9]=0,e[10]=t[2],e[11]=0,e[12]=0,e[13]=0,e[14]=0,e[15]=1,e}function au(t,e,n){n=n||new O(16);let r=e[0],i=e[1],o=e[2];return n[0]=r*t[0*4+0],n[1]=r*t[0*4+1],n[2]=r*t[0*4+2],n[3]=r*t[0*4+3],n[4]=i*t[1*4+0],n[5]=i*t[1*4+1],n[6]=i*t[1*4+2],n[7]=i*t[1*4+3],n[8]=o*t[2*4+0],n[9]=o*t[2*4+1],n[10]=o*t[2*4+2],n[11]=o*t[2*4+3],t!==n&&(n[12]=t[12],n[13]=t[13],n[14]=t[14],n[15]=t[15]),n}function su(t,e){return e=e||new O(16),e[0]=t,e[1]=0,e[2]=0,e[3]=0,e[4]=0,e[5]=t,e[6]=0,e[7]=0,e[8]=0,e[9]=0,e[10]=t,e[11]=0,e[12]=0,e[13]=0,e[14]=0,e[15]=1,e}function lu(t,e,n){return n=n||new O(16),n[0]=e*t[0*4+0],n[1]=e*t[0*4+1],n[2]=e*t[0*4+2],n[3]=e*t[0*4+3],n[4]=e*t[1*4+0],n[5]=e*t[1*4+1],n[6]=e*t[1*4+2],n[7]=e*t[1*4+3],n[8]=e*t[2*4+0],n[9]=e*t[2*4+1],n[10]=e*t[2*4+2],n[11]=e*t[2*4+3],t!==n&&(n[12]=t[12],n[13]=t[13],n[14]=t[14],n[15]=t[15]),n}var M={__proto__:null,aim:jc,axisRotate:Eo,axisRotation:To,cameraAim:Yc,clone:Cc,copy:Cr,create:yc,determinant:Bc,equals:Dc,equalsApproximately:Ac,fromMat3:Ec,fromQuat:Mc,frustum:$c,frustumReverseZ:Wc,getAxis:Lc,getScaling:zc,getTranslation:Nc,identity:wo,inverse:Po,invert:Oc,lookAt:Xc,mul:Fc,multiply:yo,negate:Ic,ortho:Hc,perspective:kc,perspectiveReverseZ:Vc,rotate:iu,rotateX:Jc,rotateY:eu,rotateZ:nu,rotation:ru,rotationX:Zc,rotationY:Qc,rotationZ:tu,scale:au,scaling:ou,set:Tc,setAxis:Uc,setDefaultType:Pc,setTranslation:Gc,translate:Kc,translation:qc,transpose:Rc,uniformScale:lu,uniformScaling:su};var H=Float32Array;function cu(t){let e=H;return H=t,e}function Mo(t,e,n,r){let i=new H(4);return t!==void 0&&(i[0]=t,e!==void 0&&(i[1]=e,n!==void 0&&(i[2]=n,r!==void 0&&(i[3]=r)))),i}var uu=Mo;function fu(t,e,n,r,i){return i=i||new H(4),i[0]=t,i[1]=e,i[2]=n,i[3]=r,i}function du(t,e){return e=e||new H(4),e[0]=Math.ceil(t[0]),e[1]=Math.ceil(t[1]),e[2]=Math.ceil(t[2]),e[3]=Math.ceil(t[3]),e}function pu(t,e){return e=e||new H(4),e[0]=Math.floor(t[0]),e[1]=Math.floor(t[1]),e[2]=Math.floor(t[2]),e[3]=Math.floor(t[3]),e}function mu(t,e){return e=e||new H(4),e[0]=Math.round(t[0]),e[1]=Math.round(t[1]),e[2]=Math.round(t[2]),e[3]=Math.round(t[3]),e}function hu(t,e=0,n=1,r){return r=r||new H(4),r[0]=Math.min(n,Math.max(e,t[0])),r[1]=Math.min(n,Math.max(e,t[1])),r[2]=Math.min(n,Math.max(e,t[2])),r[3]=Math.min(n,Math.max(e,t[3])),r}function gu(t,e,n){return n=n||new H(4),n[0]=t[0]+e[0],n[1]=t[1]+e[1],n[2]=t[2]+e[2],n[3]=t[3]+e[3],n}function _u(t,e,n,r){return r=r||new H(4),r[0]=t[0]+e[0]*n,r[1]=t[1]+e[1]*n,r[2]=t[2]+e[2]*n,r[3]=t[3]+e[3]*n,r}function Io(t,e,n){return n=n||new H(4),n[0]=t[0]-e[0],n[1]=t[1]-e[1],n[2]=t[2]-e[2],n[3]=t[3]-e[3],n}var xu=Io;function Su(t,e){return Math.abs(t[0]-e[0])<Y&&Math.abs(t[1]-e[1])<Y&&Math.abs(t[2]-e[2])<Y&&Math.abs(t[3]-e[3])<Y}function vu(t,e){return t[0]===e[0]&&t[1]===e[1]&&t[2]===e[2]&&t[3]===e[3]}function Co(t,e,n,r){return r=r||new H(4),r[0]=t[0]+n*(e[0]-t[0]),r[1]=t[1]+n*(e[1]-t[1]),r[2]=t[2]+n*(e[2]-t[2]),r[3]=t[3]+n*(e[3]-t[3]),r}function bu(t,e,n,r){return r=r||new H(4),r[0]=t[0]+n[0]*(e[0]-t[0]),r[1]=t[1]+n[1]*(e[1]-t[1]),r[2]=t[2]+n[2]*(e[2]-t[2]),r[3]=t[3]+n[3]*(e[3]-t[3]),r}function wu(t,e,n){return n=n||new H(4),n[0]=Math.max(t[0],e[0]),n[1]=Math.max(t[1],e[1]),n[2]=Math.max(t[2],e[2]),n[3]=Math.max(t[3],e[3]),n}function Pu(t,e,n){return n=n||new H(4),n[0]=Math.min(t[0],e[0]),n[1]=Math.min(t[1],e[1]),n[2]=Math.min(t[2],e[2]),n[3]=Math.min(t[3],e[3]),n}function Ar(t,e,n){return n=n||new H(4),n[0]=t[0]*e,n[1]=t[1]*e,n[2]=t[2]*e,n[3]=t[3]*e,n}var yu=Ar;function Tu(t,e,n){return n=n||new H(4),n[0]=t[0]/e,n[1]=t[1]/e,n[2]=t[2]/e,n[3]=t[3]/e,n}function Ao(t,e){return e=e||new H(4),e[0]=1/t[0],e[1]=1/t[1],e[2]=1/t[2],e[3]=1/t[3],e}var Eu=Ao;function Mu(t,e){return t[0]*e[0]+t[1]*e[1]+t[2]*e[2]+t[3]*e[3]}function Dr(t){let e=t[0],n=t[1],r=t[2],i=t[3];return Math.sqrt(e*e+n*n+r*r+i*i)}var Iu=Dr;function Do(t){let e=t[0],n=t[1],r=t[2],i=t[3];return e*e+n*n+r*r+i*i}var Cu=Do;function Ro(t,e){let n=t[0]-e[0],r=t[1]-e[1],i=t[2]-e[2],o=t[3]-e[3];return Math.sqrt(n*n+r*r+i*i+o*o)}var Au=Ro;function Bo(t,e){let n=t[0]-e[0],r=t[1]-e[1],i=t[2]-e[2],o=t[3]-e[3];return n*n+r*r+i*i+o*o}var Du=Bo;function Oo(t,e){e=e||new H(4);let n=t[0],r=t[1],i=t[2],o=t[3],a=Math.sqrt(n*n+r*r+i*i+o*o);return a>1e-5?(e[0]=n/a,e[1]=r/a,e[2]=i/a,e[3]=o/a):(e[0]=0,e[1]=0,e[2]=0,e[3]=0),e}function Ru(t,e){return e=e||new H(4),e[0]=-t[0],e[1]=-t[1],e[2]=-t[2],e[3]=-t[3],e}function Rr(t,e){return e=e||new H(4),e[0]=t[0],e[1]=t[1],e[2]=t[2],e[3]=t[3],e}var Bu=Rr;function Fo(t,e,n){return n=n||new H(4),n[0]=t[0]*e[0],n[1]=t[1]*e[1],n[2]=t[2]*e[2],n[3]=t[3]*e[3],n}var Ou=Fo;function Go(t,e,n){return n=n||new H(4),n[0]=t[0]/e[0],n[1]=t[1]/e[1],n[2]=t[2]/e[2],n[3]=t[3]/e[3],n}var Fu=Go;function Gu(t){return t=t||new H(4),t[0]=0,t[1]=0,t[2]=0,t[3]=0,t}function Nu(t,e,n){n=n||new H(4);let r=t[0],i=t[1],o=t[2],a=t[3];return n[0]=e[0]*r+e[4]*i+e[8]*o+e[12]*a,n[1]=e[1]*r+e[5]*i+e[9]*o+e[13]*a,n[2]=e[2]*r+e[6]*i+e[10]*o+e[14]*a,n[3]=e[3]*r+e[7]*i+e[11]*o+e[15]*a,n}function No(t,e,n){return n=n||new H(4),Oo(t,n),Ar(n,e,n)}function Lu(t,e,n){return n=n||new H(4),Dr(t)>e?No(t,e,n):Rr(t,n)}function Uu(t,e,n){return n=n||new H(4),Co(t,e,.5,n)}var K={__proto__:null,add:gu,addScaled:_u,ceil:du,clamp:hu,clone:Bu,copy:Rr,create:Mo,dist:Au,distSq:Du,distance:Ro,distanceSq:Bo,div:Fu,divScalar:Tu,divide:Go,dot:Mu,equals:vu,equalsApproximately:Su,floor:pu,fromValues:uu,inverse:Ao,invert:Eu,len:Iu,lenSq:Cu,length:Dr,lengthSq:Do,lerp:Co,lerpV:bu,max:wu,midpoint:Uu,min:Pu,mul:Ou,mulScalar:Ar,multiply:Fo,negate:Ru,normalize:Oo,round:mu,scale:yu,set:fu,setDefaultType:cu,setLength:No,sub:xu,subtract:Io,transformMat4:Nu,truncate:Lu,zero:Gu};var qe=class{constructor(e,n=0,r=0){this.buffer=e;this.byteOffset=n;this.byteSize=r;this.byteSize=r===0?e.byteLength:r,this.asF32=new Float32Array(e),this.asU32=new Uint32Array(e)}asF32;asU32;offsetBytes=0;f32=e=>this.asF32[e];u32=e=>this.asU32[e];cursor=()=>this.offsetBytes;resetCursor(){this.offsetBytes=0}padding(e){this.offsetBytes+=e}assertWrittenBytes(e){if(this.offsetBytes!==e)throw new Error(`Written invalid byte count ${this.offsetBytes}. Expected ${e}.`);if(this.offsetBytes%16!==0){let n=ot(this.offsetBytes,16)*16,r=(n-this.offsetBytes)/X;throw new Error(`Byte count ${this.offsetBytes} does not cleanly divide by 16. This might lead to errors. Add padding to fill to ${n} bytes (${r} u32 elements is enough).`)}}writeMat4(e){for(let n=0;n<16;n++)this.writeF32(e[n])}writeF32Array(e){for(let n=0;n<e.length;n++)this.writeF32(e[n])}writeF32(e){let n=(this.byteOffset+this.offsetBytes)/Te;this.asF32[n]=e,this.offsetBytes+=Te}writeU32(e){let n=(this.byteOffset+this.offsetBytes)/X;this.asU32[n]=Math.floor(e),this.offsetBytes+=X}upload(e,n,r){e.queue.writeBuffer(n,r,this.buffer,this.byteOffset,this.byteSize)}};var Be=t=>{let{tileSize:e}=u.hairRender;return{width:ot(t.width,e),height:ot(t.height,e)}};var zu=`
...
${e=="read_write"?zu:ku}
`;function Br(t){let e=Be(t);return 1+Math.ceil(e.width*e.height*u.hairRender.avgSegmentsPerTile)}function Lo(t,e){let n=Br(e),r=2*X,i=Math.max(n*r,ve);k.update("Tiles segments",Se(i));let o=u.isTest?GPUBufferUsage.COPY_SRC:0;return t.createBuffer({label:"hair-segments-per-tile",size:i,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST|o})}function Or(t,e){let n=e.width/e.height;return M.perspective(Ae(t.fovDgr),n,t.near,t.far)}function wn(t,e,n){return M.multiply(e,t,n)}function Fr(t,e,n,r){return r=M.multiply(e,t,r),r=M.multiply(n,r,r),r}function ht(t,e,n){let r;if(e.length===4){if(e[3]!==1)throw new Error("Tried to project a point, but provided Vec4 has .w !== 1");r=e}else r=K.create(e[0],e[1],e[2],1);return K.transformMat4(r,t,n)}function Gr(t,e,n){let r=ht(t,e,n);return K.divScalar(r,r[3],r),r}var Vu=M.create(),Hu=M.create(),$u=M.create(),Wu=y.create(),Nr=K.create();function Lr(){let t=u.shadows.source,e=dt(t.posPhi,t.posTheta,"dgr",Wu);return y.scale(e,t.distance,e),e}function Uo(t){let e=Lr(),n=u.shadows.source,r=ht(t,n.target,Nr);return M.lookAt(e,r,$i,Hu)}var Pn=1.05,yn=9999999;function zo(t,e,n){let r=M.multiply(e,t,$u),i=yn,o=-yn,a=yn,s=-yn,l=.1,c=20,d=f=>{let m=K.set(f.center[0],f.center[1],f.center[2],1,Nr),v=ht(r,m,Nr);i=Math.min(i,v[0]-f.radius),o=Math.max(o,v[0]+f.radius),a=Math.min(a,v[1]-f.radius),s=Math.max(s,v[1]+f.radius)};d(n.hairObject.bounds.sphere);for(let f of n.objects)f.isColliderPreview||d(f.bounds.sphere);return M.ortho(i*Pn,o*Pn,a*Pn,s*Pn,l,c,Vu)}var ju=500;function Tn(t){return Math.floor(Math.min(ju,t.width/3,t.height/3))}var se=class{constructor(e,n,r,i,o,a){this.name=e;this.bounds=n;this.dims=r;this.texture=i;this.textureView=o;this.sampler=a;u.isTest||$(o);let[s,l]=n,c=y.subtract(l,s),d=y.scale(c,1/(r-1));u.isTest||console.log(`SDF collider '${e}' (dims=${r}, cellSize=${d}), bounds:`,n)}static SDF_DATA_SNIPPET=`
    struct SDFCollider {
      boundsMin: vec4f,
      boundsMax: vec4f,
    };
  ...
  `;bindTexture=e=>({binding:e,resource:this.textureView});bindSampler=e=>({binding:e,resource:this.sampler});writeToDataView(e){let n=u.hairSimulation.sdf,[r,i]=this.bounds;e.writeF32(r[0]),e.writeF32(r[1]),e.writeF32(r[2]);let o=n.debugSemitransparent?2:0;e.writeF32(n.debugSlice+o),e.writeF32(i[0]),e.writeF32(i[1]),e.writeF32(i[2]),e.writeF32(n.distanceOffset)}};function ko(t,e){let n=e?qu(t,e):Ur(t);return{box:n,sphere:zr(n)}}function Yu(t,e=hr,n){let r=t.length/e,i=[0,0,0];for(let o=0;o<r;o++){let a=o*e;i[0]=t[a],i[1]=t[a+1],i[2]=t[a+2],n(i)}}function Xu(t,e,n){let r=[0,0,0];for(let i=0;i<e.length;i++){let o=e[i]*De;r[0]=t[o],r[1]=t[o+1],r[2]=t[o+2],n(r)}}function Vo(){let t=[void 0,void 0,void 0],e=[void 0,void 0,void 0];return[[e,t],r=>{for(let i=0;i<3;i++)t[i]=t[i]!==void 0?Math.max(t[i],r[i]):r[i],e[i]=e[i]!==void 0?Math.min(e[i],r[i]):r[i]}]}function Ur(t,e=hr){let[n,r]=Vo();return Yu(t,e,r),n}function qu(t,e){let[n,r]=Vo();return Xu(t,e,r),n}function zr([t,e]){let n=y.midpoint(t,e),r=y.distance(n,e);return{center:n,radius:r}}function Ho(t,e){if(e<=0)throw new Error(`Invalid scale=${e}`);let[n,r]=t,i=y.midpoint(n,r),o=y.subtract(r,i),a=y.scale(o,e);return[y.subtract(i,a),y.add(i,a)]}var kr=1e6,Ke=`
...
`;var Oe=class{static GRID_DATA_SNIPPET=`
  ...
  `;static BUFFER_SIZE=2*J;densityVelocityBuffer;densityGradAndWindBuffer;bounds;constructor(e,n){if(this.bounds=Ho(n,u.hairSimulation.physicsForcesGrid.scale),u.isTest){this.densityVelocityBuffer=void 0,this.densityGradAndWindBuffer=void 0;return}let r=u.hairSimulation.physicsForcesGrid.dims,[i,o]=this.bounds,a=y.subtract(o,i),s=y.scale(a,1/(r-1)),l=r*r*r;console.log(`Physics grid (dims=${r}x${r}x${r}, ${l} points, cellSize=${s}), bounds:`,this.bounds),this.densityVelocityBuffer=$o(e,"grid-density-velocity",r),this.densityGradAndWindBuffer=$o(e,"grid-density-grad-and-wind",r)}clearDensityVelocityBuffer(e){e.clearBuffer(this.densityVelocityBuffer,0,this.densityVelocityBuffer.size)}clearDensityGradAndWindBuffer(e){e.clearBuffer(this.densityGradAndWindBuffer,0,this.densityGradAndWindBuffer.size)}bindDensityVelocityBuffer=e=>L(e,this.densityVelocityBuffer);bindDensityGradAndWindBuffer=e=>L(e,this.densityGradAndWindBuffer);getDebuggedGridBuffer(){let e=u.hairSimulation.physicsForcesGrid.debugValue;return e==xe.WIND||e==xe.DENSITY_GRADIENT?this.densityGradAndWindBuffer:this.densityVelocityBuffer}writeToDataView(e){let n=u.hairSimulation.physicsForcesGrid,[r,i]=this.bounds;e.writeF32(r[0]),e.writeF32(r[1]),e.writeF32(r[2]),e.writeF32(n.debugSlice),e.writeF32(i[0]),e.writeF32(i[1]),e.writeF32(i[2]),e.writeU32(n.debugValue+(n.debugAbsValue?16:0))}};function $o(t,e,n){let r=n*n*n,o=Math.max(ve,r*4),a=new Int32Array(o),s=c=>Math.floor(c*kr);for(let c=0;c<n;c++)for(let d=0;d<n;d++)for(let f=0;f<n;f++){let m=c*n*n+d*n+f,v=f==1||f==5;a[4*m+3]=s(v?1:0)}let l=be(t,e,a);return k.update("Physics grid","2 * "+Se(l.size)),l}var $e=M.create(),Ku=M.create(),C=class t{static SHADER_SNIPPET=e=>`
...
`;function We(t){t.draw(3)}var D=class{cache={};getBindings(e,n){let r=this.cache[e];if(r)return r;let i=n();return this.cache[e]=i,i}clear(){this.cache={}}};var Ut=(t,e="")=>`${t.NAME}${e?"-"+e:""}`,B=(t,e="")=>`${Ut(t,e)}-shader`,F=(t,e="")=>`${Ut(t,e)}-pipeline`,Qu=(t,e="")=>`${Ut(t,e)}-uniforms`,_t={cullMode:"back",topology:"triangle-list",stripIndexFormat:void 0},xt={format:hn,depthWriteEnabled:!0,depthCompare:"less"},le=(t,e,n,r)=>Z(t,"",e,n,r),Z=(t,e,n,r,i)=>{let o=r.getBindGroupLayout(0);return n.createBindGroup({label:Qu(t,e),layout:o,entries:i})},ee=(t,e,n,r="store")=>($(t),{view:t,loadOp:n,storeOp:r,clearValue:e}),St=(t,e,n="store")=>($(t),{view:t,depthClearValue:1,depthLoadOp:e,depthStoreOp:n}),Vr=(t,e,n,r="",i="main")=>{let o=t.createShaderModule({label:B(e,r),code:n});return t.createComputePipeline({label:F(e,r),layout:"auto",compute:{module:o,entryPoint:i}})};var Wo=`
...
fn getDitherForPixel(gl_FragCoord: vec2u) -> f32 {
  ...
  let matValue = DITHER_MATRIX[${pn?"0":"idx"}]; // [1-64]
...
`;var Cn="mat4x4<f32>",he=`
fn getMVP_Mat(modelMat: ${Cn}, viewMat: ${Cn}, projMat: ${Cn}) -> ${Cn} {
...
`;var Hr={bindings:{renderUniforms:0,resultHDR_Texture:1,depthTexture:2,normalsTexture:3,aoTexture:4}},zt=Hr.bindings,Yo=()=>`
...
@group(0) @binding(${zt.resultHDR_Texture})
var _resultHDR_Texture: texture_2d<f32>;

@group(0) @binding(${zt.depthTexture})
var _depthTexture: texture_depth_2d;

@group(0) @binding(${zt.normalsTexture})
...
`;var $r={bindings:{renderUniforms:0,depthTexture:1}},Xo=$r.bindings,qo=()=>`

${Fe}

${C.SHADER_SNIPPET(Xo.renderUniforms)}

@group(0) @binding(${Xo.depthTexture})
var _depthTexture: texture_depth_2d;
...
`;var An="dbg-shadow-map",Dn=class t{static NAME="PresentPass";pipeline;pipelineDbgShadowMap;bindingsCache=new D;constructor(e,n){let r=e.createShaderModule({label:B(t),code:Yo()});this.pipeline=this.createPipeline(e,n,r,""),r=e.createShaderModule({label:B(t,An),code:qo()}),this.pipelineDbgShadowMap=this.createPipeline(e,n,r,An)}createPipeline=(e,n,r,i)=>e.createRenderPipeline({label:F(t,i),layout:"auto",vertex:{module:r,entryPoint:"main_vs",buffers:[]},fragment:{module:r,entryPoint:"main_fs",targets:[{format:n}]},primitive:{topology:"triangle-list"}});onViewportResize=()=>this.bindingsCache.clear();cmdDraw(e,n,r){let{cmdBuf:i,profiler:o}=e;$(n);let a=i.beginRenderPass({label:t.NAME,colorAttachments:[ee(n,u.clearColor,r)],timestampWrites:o?.createScopeGpu(t.NAME)}),s=this.bindingsCache.getBindings("-",()=>this.createBindings(e));a.setBindGroup(0,s),a.setPipeline(this.pipeline),We(a),u.shadows.showDebugView&&this.renderDbgShadowMap(e,a),a.end()}createBindings=e=>{let{device:n,globalUniforms:r,hdrRenderTexture:i,normalsTexture:o,depthTexture:a,aoTexture:s}=e,l=Hr.bindings;return $(i),le(t,n,this.pipeline,[r.createBindingDesc(l.renderUniforms),{binding:l.resultHDR_Texture,resource:i},{binding:l.depthTexture,resource:a},{binding:l.normalsTexture,resource:o},{binding:l.aoTexture,resource:s}])};renderDbgShadowMap(e,n){let{viewport:r}=e,i=this.pipelineDbgShadowMap,o=this.bindingsCache.getBindings(An,()=>this.createDbgShadowMapBindings(e,i)),a=Tn(r);n.setBindGroup(0,o),n.setPipeline(i);let s=u.shadows.debugViewPosition,l=s[0],c=s[1];n.setViewport(l,c,a,a,0,1),We(n)}createDbgShadowMapBindings=(e,n)=>{let{device:r,globalUniforms:i,shadowDepthTexture:o}=e,a=$r.bindings;return $(o),Z(t,An,r,n,[i.createBindingDesc(a.renderUniforms),{binding:a.depthTexture,resource:o}])}};var Wr={attributes:[{shaderLocation:0,offset:0,format:"float32x3"}],arrayStride:mr,stepMode:"vertex"},Ko=[Wr,{attributes:[{shaderLocation:1,offset:0,format:"float32x3"}],arrayStride:mr,stepMode:"vertex"},{attributes:[{shaderLocation:2,offset:0,format:"float32x2"}],arrayStride:zi,stepMode:"vertex"}];var jr=`
...
`;function Jo(t){return t.createSampler({label:"shadow-map-sampler"})}var wt={firstInstance:{sintel:0,colliderPreview:1},bindings:{renderUniforms:0,shadowMapTexture:1,shadowMapSampler:2,aoTexture:3}},Yr=[.9,.9,.9],tf=wt,Bn=wt.bindings,Qo=()=>`

${he}
${G}
${Ge}
${Zo}
${Rn({bindingTexture:Bn.shadowMapTexture,bindingSampler:Bn.shadowMapSampler})}

${C.SHADER_SNIPPET(Bn.renderUniforms)}
${bt(Bn.aoTexture)}
...
fn main_vs(
  ...
  if (instanceIdx == ${tf.firstInstance.colliderPreview}u) {
...
`;var Xr={bindings:{renderUniforms:0}},nf=Xr.bindings,ea=()=>`

${Fe}
${Fn}

${C.SHADER_SNIPPET(nf.renderUniforms)}
...
`;var Gn=class t{static NAME="DrawBackgroundGradientPass";pipeline;bindingsCache=new D;constructor(e,n){let r=e.createShaderModule({label:B(t),code:ea()});this.pipeline=e.createRenderPipeline({label:F(t),layout:"auto",vertex:{module:r,entryPoint:"main_vs",buffers:[]},fragment:{module:r,entryPoint:"main_fs",targets:[{format:n}]},primitive:{topology:"triangle-list"}})}onViewportResize=()=>this.bindingsCache.clear();cmdDraw(e){let{cmdBuf:n,profiler:r,hdrRenderTexture:i}=e;$(i);let o=n.beginRenderPass({label:t.NAME,colorAttachments:[ee(i,u.clearColor,"load")],timestampWrites:r?.createScopeGpu(t.NAME)}),a=this.bindingsCache.getBindings("-",()=>this.createBindings(e));o.setBindGroup(0,a),o.setPipeline(this.pipeline),We(o),o.end()}createBindings=({device:e,globalUniforms:n})=>{let r=Xr.bindings;return le(t,e,this.pipeline,[n.createBindingDesc(r.renderUniforms)])}};var ta=(t,e)=>{let n=t*(e-1)*6;return Math.floor(n/3)};function na(t,e,n){let{numHairStrands:r,numVerticesPerStrand:i}=n.header,o=r*(i-1),a=Array(o*6).fill(0),s=0,l=0;for(let f=0;f<r;f++){for(let m=0;m<i-1;m++)a[l++]=2*s,a[l++]=2*s+1,a[l++]=2*s+2,a[l++]=2*s+2,a[l++]=2*s+1,a[l++]=2*s+3,s++;s++}let c=Uint32Array.from(a);return{indexBuffer:bn(t,`${e}-indices`,c),indexFormat:"uint32",triangleCount:Math.floor(l/3)}}var Pe=t=>`
...
`;function ra(t,e,n,r){let i=ve,o=new ArrayBuffer(i),a=new qe(o);return a.writeF32(r.center[0]),a.writeF32(r.center[1]),a.writeF32(r.center[2]),a.writeF32(r.radius),a.writeU32(n.header.numHairStrands),a.writeU32(n.header.numVerticesPerStrand),be(t,`${e}-hair-data`,a.asU32)}var ut=(t,e)=>`
...
`,Ne=t=>ut(t,{bufferName:"_hairPointPositions",getterName:"_getHairPointPosition"}),ia=(t,e)=>`
...
`;function oa(t,e,n,r){return be(t,`${e}-points-positions`,n,r)}var rf=`
...
`;function aa(t,e,n){let{header:{numHairStrands:r}}=n,{shadingPoints:i}=u.hairRender,o=Ye(i).map((s,l)=>{let c=l/(i-1);return[1-c,c,0,1]}),a=new Float32Array(Ye(r).map(()=>o).flat().flat());return be(t,`${e}-shading`,a)}var Le=t=>`
...
`;function of(t,e){let n=y.subtract(t,e);return y.normalize(n,n)}function sa(t,e,n){let{vertexPositions:r,header:{numHairStrands:i,numVerticesPerStrand:o}}=n,a=new Float32Array(r.length),s=c=>[r[c*4],r[c*4+1],r[c*4+2]],l=(c,d)=>{a[c*4+0]=d[0],a[c*4+1]=d[1],a[c*4+2]=d[2],a[c*4+3]=0};for(let c=0;c<i;c++){let d=c*o;for(let f=0;f<o;f++){let v=f==o-1?f-1:f,b=s(d+v),x=s(d+v+1),g=of(x,b);l(d+f,g)}}return be(t,`${e}-tangents`,a)}var Nn=`
...
`;var qr={bindings:{renderUniforms:0,hairPositions:1,hairTangents:2,hairData:3,hairShading:4}},kt=qr.bindings,la=()=>`
...
`;var Ze=class t{static NAME="HwHairPass";pipeline;bindingsCache=new D;constructor(e,n,r){let i=e.createShaderModule({label:B(t),code:la()}),o=t.createPipelineDesc(i);o.fragment?.targets.push({format:n,blend:{color:{srcFactor:"src-alpha",dstFactor:"one-minus-src-alpha"},alpha:{srcFactor:"src-alpha",dstFactor:"one-minus-src-alpha"}}},{format:r}),this.pipeline=e.createRenderPipeline(o)}static createPipelineDesc(e){return{label:F(t),layout:"auto",vertex:{module:e,entryPoint:"main_vs",buffers:[]},fragment:{module:e,entryPoint:"main_fs",targets:[]},primitive:{cullMode:"none",topology:"triangle-list",stripIndexFormat:void 0},depthStencil:xt}}cmdDrawHair(e){let{cmdBuf:n,profiler:r,depthTexture:i,hdrRenderTexture:o,normalsTexture:a,scene:s}=e,l=n.beginRenderPass({label:t.NAME,colorAttachments:[ee(o,u.clearColor,"load"),ee(a,u.clearNormals,"load")],depthStencilAttachment:St(i,"load"),timestampWrites:r?.createScopeGpu(t.NAME)});l.setPipeline(this.pipeline);let c=s.hairObject,d=this.bindingsCache.getBindings(c.name,()=>this.createBindings(e,c));l.setBindGroup(0,d),t.cmdRenderHair(l,c),l.end(),c.reportRenderedStrandCount()}static cmdRenderHair(e,n){n.bindIndexBuffer(e);let r=n.getRenderedStrandCount(),o=ta(r,n.pointsPerStrand)*De;e.drawIndexed(o,1,0,0,0)}createBindings=({device:e,globalUniforms:n},r)=>{let i=qr.bindings;return Z(t,r.name,e,this.pipeline,[n.createBindingDesc(i.renderUniforms),r.bindPointsPositions(i.hairPositions),r.bindTangents(i.hairTangents),r.bindHairData(i.hairData),r.bindShading(i.hairShading)])}};var Ln=`
...
`;function ca(t,e){let n=u.hairRender.tileDepthBins,r=Be(e);console.log(`Creating hair tiles buffer: ${r.width}x${r.height}x${n} tiles`),k.update("Tiles",`${r.width} x ${r.height} x ${n}`);let i=r.width*r.height*n,o=4*X,a=i*o;k.update("Tiles heads",Se(a));let s=u.isTest?GPUBufferUsage.COPY_SRC:0;return t.createBuffer({label:"hair-tiles-result",size:a,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST|s})}var Ue=`
...
@compute
@workgroup_size(${fa.workgroupSizeX}, ${fa.workgroupSizeY}, 1)
fn main(
...
${e=="read_write"?cf:""}
`;function pa(t,e){let i=e.width*e.height*J;return k.update("Hair FBO",Se(i)),t.createBuffer({label:"hair-rasterizer-result",size:i,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST})}var Kr={bindings:{renderUniforms:0,tilesBuffer:1,tileSegmentsBuffer:2,rasterizeResultBuffer:3,segmentCountPerTile:4}},Vt=Kr.bindings,ma=()=>`
...
${zn(Vt.rasterizeResultBuffer,"read")}
...
`;var kn=class t{static NAME="HairCombinePass";pipeline;bindingsCache=new D;constructor(e,n){let r=e.createShaderModule({label:B(t),code:ma()});this.pipeline=e.createRenderPipeline({label:F(t),layout:"auto",vertex:{module:r,entryPoint:"main_vs",buffers:[]},fragment:{module:r,entryPoint:"main_fs",targets:[{format:n,blend:{color:{srcFactor:"src-alpha",dstFactor:"one-minus-src-alpha",operation:"add"},alpha:{srcFactor:"one",dstFactor:"one",operation:"add"}}}]},primitive:{topology:"triangle-list"}})}onViewportResize=()=>this.bindingsCache.clear();cmdCombineRasterResults(e){let{cmdBuf:n,profiler:r,hdrRenderTexture:i,depthTexture:o}=e;$(i);let a=n.beginRenderPass({label:t.NAME,colorAttachments:[ee(i,u.clearColor,"load")],timestampWrites:r?.createScopeGpu(t.NAME)}),s=this.bindingsCache.getBindings(o.label,()=>this.createBindings(e));a.setBindGroup(0,s),a.setPipeline(this.pipeline),We(a),a.end()}createBindings=e=>{let{device:n,globalUniforms:r,hairTilesBuffer:i,hairTileSegmentsBuffer:o,hairRasterizerResultsBuffer:a,hairSegmentCountPerTileBuffer:s}=e,l=Kr.bindings;return le(t,n,this.pipeline,[r.createBindingDesc(l.renderUniforms),L(l.tilesBuffer,i),L(l.tileSegmentsBuffer,o),L(l.rasterizeResultBuffer,a),L(l.segmentCountPerTile,s)])}};var Vn=u.hairRender,ha=Vn.avgFragmentsPerSlice*Vn.slicesPerPixel*Vn.tileSize*Vn.tileSize,ga=(t,e)=>`

const SLICE_DATA_PER_PROCESSOR_COUNT = ${ha}u;
...
`;function _a(t){let{processorCount:e}=u.hairRender,n=ha*e,r=4*X,i=Math.max(n*r,ve);return k.update("Slices data",Se(i)),t.createBuffer({label:"hair-slices-data",size:i,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST})}var xa=()=>`
...
${zn(ye.rasterizerResult,"read_write")}
${qi(ye.hairSlicesHeads,"read_write")}
${ga(ye.hairSlicesData,"read_write")}
...
@compute
@workgroup_size(${ff.workgroupSizeX}, 1, 1)
fn main(
  @builtin(global_invocation_id) global_id: vec3<u32>,
...
`;var Et={workgroupSizeX:1,workgroupSizeY:u.hairRender.shadingPoints,bindings:{renderUniforms:0,hairData:1,hairPositions:2,hairTangents:3,hairShading:4,shadowMapTexture:5,shadowMapSampler:6,aoTexture:7,depthTexture:8}},Pa=Et,je=Et.bindings,ya=()=>`
...
`;var Qr={bindings:{renderUniforms:0,hairPositions:1,hairTangents:2}},Jr=Qr.bindings,Ea=()=>`
...
${C.SHADER_SNIPPET(Jr.renderUniforms)}
${Ne(Jr.hairPositions)}
${Le(Jr.hairTangents)}
...
`;var jn=class t{static NAME="ShadowMapPass";pipelineMeshes;pipelineHair;bindingsCache=new D;shadowMapSampler;shadowDepthTexture;shadowDepthTextureView;constructor(e){this.shadowMapSampler=Jo(e);let n=e.createShaderModule({label:B(t),code:Ta()});this.pipelineMeshes=e.createRenderPipeline({label:F(t),layout:"auto",vertex:{module:n,entryPoint:"main_vs",buffers:[Wr]},fragment:{module:n,entryPoint:"main_fs",targets:[]},primitive:{..._t,cullMode:"none"},depthStencil:{...xt,format:u.shadows.depthFormat}});let r=e.createShaderModule({label:B(t),code:Ea()}),i=Ze.createPipelineDesc(r);this.pipelineHair=e.createRenderPipeline(i);let o=u.shadows;this.shadowDepthTexture=e.createTexture({label:"shadowmap-depth-texture",size:[o.textureSize,o.textureSize,1],format:o.depthFormat,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING}),this.shadowDepthTextureView=this.shadowDepthTexture.createView()}cmdUpdateShadowMap(e){let{cmdBuf:n,profiler:r,shadowDepthTexture:i,scene:o}=e,a=n.beginRenderPass({label:t.NAME,colorAttachments:[],depthStencilAttachment:St(i,"clear"),timestampWrites:r?.createScopeGpu(t.NAME)});a.setPipeline(this.pipelineMeshes);let s=this.bindingsCache.getBindings("meshes",()=>this.createBindingsMeshes(e));a.setBindGroup(0,s);for(let c of o.objects)this.renderMesh(a,c);let l=o.hairObject;a.setPipeline(this.pipelineHair),s=this.bindingsCache.getBindings(`hair-${l.name}`,()=>this.createBindingsHair(e,l)),a.setBindGroup(0,s),Ze.cmdRenderHair(a,l),a.end()}renderMesh(e,n){if(n.isColliderPreview)return;e.setVertexBuffer(0,n.positionsBuffer),e.setIndexBuffer(n.indexBuffer,"uint32");let r=n.triangleCount*De;e.drawIndexed(r,1,0,0,0)}createBindingsMeshes=({device:e,globalUniforms:n})=>{let r=Zr.bindings;return le(t,e,this.pipelineMeshes,[n.createBindingDesc(r.renderUniforms)])};createBindingsHair=({device:e,globalUniforms:n},r)=>{let i=Qr.bindings;return Z(Ze,r.name,e,this.pipelineHair,[n.createBindingDesc(i.renderUniforms),r.bindPointsPositions(i.hairPositions),r.bindTangents(i.hairTangents)])}};var ei=u.camera,hf=2*Math.tan(Ae(ei.projection.fovDgr)*.5),Ma=`
...
`;var ni={bindings:{renderUniforms:0,depthTexture:1,normalsTexture:2}},ti=ni.bindings,Ia=()=>`
...
${C.SHADER_SNIPPET(ti.renderUniforms)}
...
`;var Yn=class t{static NAME="AoPass";pipeline;bindingsCache=new D;constructor(e,n){let r=e.createShaderModule({label:B(t),code:Ia()});this.pipeline=e.createRenderPipeline({label:F(t),layout:"auto",vertex:{module:r,entryPoint:"main_vs",buffers:[]},fragment:{module:r,entryPoint:"main_fs",targets:[{format:n}]},primitive:{topology:"triangle-list"}})}onViewportResize=()=>this.bindingsCache.clear();cmdCalcAo(e){let{cmdBuf:n,profiler:r,aoTexture:i}=e;$(i);let o=n.beginRenderPass({label:t.NAME,colorAttachments:[ee(i,u.clearAo,"clear")],timestampWrites:r?.createScopeGpu(t.NAME)}),a=this.bindingsCache.getBindings("-",()=>this.createBindings(e));o.setBindGroup(0,a),o.setPipeline(this.pipeline),We(o),o.end()}createBindings=e=>{let{device:n,globalUniforms:r,hdrRenderTexture:i,normalsTexture:o,depthTexture:a}=e,s=ni.bindings;return $(i),le(t,n,this.pipeline,[r.createBindingDesc(s.renderUniforms),{binding:s.depthTexture,resource:a},{binding:s.normalsTexture,resource:o}])}};var gf=M.create(),Xn=K.create(),ze=class t{static SHADER_SNIPPET=e=>`
...
`;function Aa(t,e,n,r){let i=s=>[r[s*4+0],r[s*4+1],r[s*4+2]],o=r.length/4,a=new Float32Array(o);for(let s=0;s<o;s++)s%n==n-1?a[s]=y.distance(i(s-1),i(s)):a[s]=y.distance(i(s),i(s+1));return be(t,`${e}-segmentLengths`,a)}var Mt=(t,e)=>`
...
`;var Oa=8,vf=()=>Oa*u.pointsPerStrand,$t={workgroupSizeX:Oa,bindings:{simulationUniforms:0,hairData:1,positionsPrev:2,positionsNow:3,segmentLengths:4,sdfTexture:5,sdfSampler:6,densityVelocityBuffer:7,densityGradWindBuffer:8,positionsInitial:9}},bf=$t,ke=$t.bindings,Fa=()=>`
...
${ze.SHADER_SNIPPET(ke.simulationUniforms)}
${se.TEXTURE_SDF(ke.sdfTexture,ke.sdfSampler)}
${et(ke.densityVelocityBuffer,"read")}
${Mt(ke.densityGradWindBuffer,"read")}
${Pe(ke.hairData)}
${ia(ke.positionsPrev,{bufferName:"_hairPointPositionsPrev",getterName:"_getHairPointPositionPrev",setterName:"_setHairPointPositionPrev"})}
${ut(ke.positionsNow,{bufferName:"_hairPointPositionsNow",getterName:"_getHairPointPositionNow"})}
${ut(ke.positionsInitial,{bufferName:"_hairPointPositionsInitial",getterName:"_getHairPointPositionInitial"})}
${Ca(ke.segmentLengths)}
...
fn main_vs(
  ...
  ${Jn("uv: vec2f","POSITIONS",6,"inVertexIndex")}
...
`;var Qn=class t{static NAME="DrawSdfColliderPass";pipeline;bindingsCache=new D;constructor(e,n){let r=e.createShaderModule({label:B(t),code:Ga()});this.pipeline=Kn(e,r,n,F(t))}cmdDrawSdf(e){let n=e.scene.sdfCollider,r=this.bindingsCache.getBindings(n.name,()=>this.createBindings(e,n));Zn(e,t,this.pipeline,r)}createBindings=(e,n)=>{let{device:r,globalUniforms:i}=e,o=ii.bindings;return le(t,r,this.pipeline,[i.createBindingDesc(o.renderUniforms),n.bindTexture(o.sdfTexture),n.bindSampler(o.sdfSampler)])}};var ai={bindings:{renderUniforms:0,densityVelocityBuffer:1,densityGradWindBuffer:2}},oi=ai.bindings,Na=()=>`

${G}
${Ke}

${C.SHADER_SNIPPET(oi.renderUniforms)}

${et(oi.densityVelocityBuffer,"read")}
${Mt(oi.densityGradWindBuffer,"read")}
...
`;var er=class t{static NAME="DrawGridDbgPass";pipeline;bindingsCache=new D;constructor(e,n){let r=e.createShaderModule({label:B(t),code:Na()});this.pipeline=Kn(e,r,n,F(t))}cmdDrawGridDbg(e){let n=this.bindingsCache.getBindings("-",()=>this.createBindings(e));Zn(e,t,this.pipeline,n)}createBindings=e=>{let{device:n,globalUniforms:r,physicsForcesGrid:i}=e,o=ai.bindings;return le(t,n,this.pipeline,[r.createBindingDesc(o.renderUniforms),i.bindDensityVelocityBuffer(o.densityVelocityBuffer),i.bindDensityGradAndWindBuffer(o.densityGradWindBuffer)])}};var jt={workgroupSizeX:32,bindings:{simulationUniforms:0,hairData:1,positionsPrev:2,positionsNow:3,gridBuffer:4}},Pf=jt,Wt=jt.bindings,La=()=>`

${G}
${Ke}

${ze.SHADER_SNIPPET(Wt.simulationUniforms)}
...
`;var rr=class t{static NAME="DrawGizmoPass";pipeline;bindingsCache=new D;constructor(e,n){let r=e.createShaderModule({label:B(t),code:za()});this.pipeline=e.createRenderPipeline({label:F(t),layout:"auto",vertex:{module:r,entryPoint:"main_vs"},fragment:{module:r,entryPoint:"main_fs",targets:[{format:n}]},primitive:{cullMode:"none",topology:"triangle-list"}})}onViewportResize=()=>{this.bindingsCache.clear()};cmdDrawGizmo(e){let{cmdBuf:n,profiler:r,hdrRenderTexture:i}=e,o=n.beginRenderPass({label:t.NAME,colorAttachments:[ee(i,u.clearColor,"load")],timestampWrites:r?.createScopeGpu(t.NAME)}),a=this.bindingsCache.getBindings("-",()=>this.createBindings(e));o.setPipeline(this.pipeline),o.setBindGroup(0,a);let s=u.colliderGizmo;s.isDragging?this.cmdDrawSingleAxis(o,s.activeAxis):this.cmdDrawAllAxis(o),o.end()}cmdDrawAllAxis(e){e.draw(6,3,0,0)}cmdDrawSingleAxis(e,n){n!==Ee.NONE&&e.draw(6,1,0,n)}createBindings=e=>{let{device:n,globalUniforms:r}=e,i=si.bindings;return le(t,n,this.pipeline,[r.createBindingDesc(i.renderUniforms)])}};var qt={workgroupSizeX:256,bindings:{renderUniforms:0,segmentCountPerTile:1,sortBuckets:2}},ci=(t,e)=>`
...
`,Ef=qt,li=qt.bindings,ka=()=>`

${G}
${Ue}
${ci(li.sortBuckets,"count-tiles")}

${C.SHADER_SNIPPET(li.renderUniforms)}
...
`;var Kt={workgroupSizeX:256,bindings:{renderUniforms:0,segmentCountPerTile:1,tileList:2,sortBuckets:3}},If=Kt,ir=Kt.bindings,Va=()=>`

${G}
${Ue}

${C.SHADER_SNIPPET(ir.renderUniforms)}
${Je(ir.segmentCountPerTile,"read")}
${Hn(ir.tileList,"read_write")}
${ci(ir.sortBuckets,"sort")}


var<workgroup> _bucketOffsets: array<u32, SORT_BUCKETS>;

@compute
@workgroup_size(${If.workgroupSizeX}, 1, 1)
fn main(
  @builtin(global_invocation_id) global_id: vec3<u32>,
  @builtin(local_invocation_index) local_invocation_index: u32, // threadId inside workgroup
) {
...
</div>`,Vf=function(e,n){var r=e[n];return h.isArray(arguments[2])||h.isObject(arguments[2])?new Ff(e,n,arguments[2]):h.isNumber(r)?h.isNumber(arguments[2])&&h.isNumber(arguments[3])?h.isNumber(arguments[4])?new mi(e,n,arguments[2],arguments[3],arguments[4]):new mi(e,n,arguments[2],arguments[3]):h.isNumber(arguments[4])?new ur(e,n,{min:arguments[2],max:arguments[3],step:arguments[4]}):new ur(e,n,{min:arguments[2],max:arguments[3]}):h.isString(r)?new Gf(e,n):h.isFunction(r)?new rs(e,n,""):h.isBoolean(r)?new ts(e,n):null};function Hf(t){setTimeout(t,1e3/60)}var $f=window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||Hf,Wf=function(){function t(){Ie(this,t),this.backgroundElement=document.createElement("div"),h.extend(this.backgroundElement.style,{backgroundColor:"rgba(0,0,0,0.8)",top:0,left:0,display:"none",zIndex:"1000",opacity:0,WebkitTransition:"opacity 0.2s linear",transition:"opacity 0.2s linear"}),p.makeFullscreen(this.backgroundElement),this.backgroundElement.style.position="fixed",this.domElement=document.createElement("div"),h.extend(this.domElement.style,{position:"fixed",display:"none",zIndex:"1001",opacity:0,WebkitTransition:"-webkit-transform 0.2s ease-out, opacity 0.2s linear",transition:"transform 0.2s ease-out, opacity 0.2s linear"}),document.body.appendChild(this.backgroundElement),document.body.appendChild(this.domElement);var e=this;p.bind(this.backgroundElement,"click",function(){e.hide()})}return Ce(t,[{key:"show",value:function(){var n=this;this.backgroundElement.style.display="block",this.domElement.style.display="block",this.domElement.style.opacity=0,this.domElement.style.webkitTransform="scale(1.1)",this.layout(),h.defer(function(){n.backgroundElement.style.opacity=1,n.domElement.style.opacity=1,n.domElement.style.webkitTransform="scale(1)"})}},{key:"hide",value:function(){var n=this,r=function i(){n.domElement.style.display="none",n.backgroundElement.style.display="none",p.unbind(n.domElement,"webkitTransitionEnd",i),p.unbind(n.domElement,"transitionend",i),p.unbind(n.domElement,"oTransitionEnd",i)};p.bind(this.domElement,"webkitTransitionEnd",r),p.bind(this.domElement,"transitionend",r),p.bind(this.domElement,"oTransitionEnd",r),this.backgroundElement.style.opacity=0,this.domElement.style.opacity=0,this.domElement.style.webkitTransform="scale(1.1)"}},{key:"layout",value:function(){this.domElement.style.left=window.innerWidth/2-p.getWidth(this.domElement)/2+"px",this.domElement.style.top=window.innerHeight/2-p.getHeight(this.domElement)/2+"px"}}]),t}(),jf=Af(`.dg ul{list-style:none;margin:0;padding:0;width:100%;clear:both}.dg.ac{position:fixed;top:0;left:0;right:0;height:0;z-index:0}.dg:not(.ac) .main{overflow:hidden}.dg.main{-webkit-transition:opacity .1s linear;-o-transition:opacity .1s linear;-moz-transition:opacity .1s linear;transition:opacity .1s linear}.dg.main.taller-than-window{overflow-y:auto}.dg.main.taller-than-window .close-button{opacity:1;margin-top:-1px;border-top:1px solid #2c2c2c}.dg.main ul.closed .close-button{opacity:1 !important}.dg.main:hover .close-button,.dg.main .close-button.drag{opacity:1}.dg.main .close-button{-webkit-transition:opacity .1s linear;-o-transition:opacity .1s linear;-moz-transition:opacity .1s linear;transition:opacity .1s linear;border:0;line-height:19px;height:20px;cursor:pointer;text-align:center;background-color:#000}.dg.main .close-button.close-top{position:relative}.dg.main .close-button.close-bottom{position:absolute}.dg.main .close-button:hover{background-color:#111}.dg.a{float:right;margin-right:15px;overflow-y:visible}.dg.a.has-save>ul.close-top{margin-top:0}.dg.a.has-save>ul.close-bottom{margin-top:27px}.dg.a.has-save>ul.closed{margin-top:0}.dg.a .save-row{top:0;z-index:1002}.dg.a .save-row.close-top{position:relative}.dg.a .save-row.close-bottom{position:fixed}.dg li{-webkit-transition:height .1s ease-out;-o-transition:height .1s ease-out;-moz-transition:height .1s ease-out;transition:height .1s ease-out;-webkit-transition:overflow .1s linear;-o-transition:overflow .1s linear;-moz-transition:overflow .1s linear;transition:overflow .1s linear}.dg li:not(.folder){cursor:auto;height:27px;line-height:27px;padding:0 4px 0 5px}.dg li.folder{padding:0;border-left:4px solid rgba(0,0,0,0)}.dg li.title{cursor:pointer;margin-left:-4px}.dg .closed li:not(.title),.dg .closed ul li,.dg .closed ul li>*{height:0;overflow:hidden;border:0}.dg .cr{clear:both;padding-left:3px;height:27px;overflow:hidden}.dg .property-name{cursor:default;float:left;clear:left;width:40%;overflow:hidden;text-overflow:ellipsis}.dg .cr.function .property-name{width:100%}.dg .c{float:left;width:60%;position:relative}.dg .c input[type=text]{border:0;margin-top:4px;padding:3px;width:100%;float:right}.dg .has-slider input[type=text]{width:30%;margin-left:0}.dg .slider{float:left;width:66%;margin-left:-5px;margin-right:0;height:19px;margin-top:4px}.dg .slider-fg{height:100%}.dg .c input[type=checkbox]{margin-top:7px}.dg .c select{margin-top:5px}.dg .cr.function,.dg .cr.function .property-name,.dg .cr.function *,.dg .cr.boolean,.dg .cr.boolean *{cursor:pointer}.dg .cr.color{overflow:visible}.dg .selector{display:none;position:absolute;margin-left:-9px;margin-top:23px;z-index:10}.dg .c:hover .selector,.dg .selector.drag{display:block}.dg li.save-row{padding:0}.dg li.save-row .button{display:inline-block;padding:0px 6px}.dg.dialogue{background-color:#222;width:460px;padding:15px;font-size:13px;line-height:15px}#dg-new-constructor{padding:10px;color:#222;font-family:Monaco, monospace;font-size:10px;border:0;resize:none;box-shadow:inset 1px 1px 1px #888;word-wrap:break-word;margin:12px 0;display:block;width:440px;overflow-y:scroll;height:100px;position:relative}#dg-local-explain{display:none;font-size:11px;line-height:17px;border-radius:3px;background-color:#333;padding:8px;margin-top:10px}#dg-local-explain code{font-size:10px}#dat-gui-save-locally{display:none}.dg{color:#eee;font:11px 'Lucida Grande', sans-serif;text-shadow:0 -1px 0 #111}.dg.main::-webkit-scrollbar{width:5px;background:#1a1a1a}.dg.main::-webkit-scrollbar-corner{height:0;display:none}.dg.main::-webkit-scrollbar-thumb{border-radius:5px;background:#676767}.dg li:not(.folder){background:#1a1a1a;border-bottom:1px solid #2c2c2c}.dg li.save-row{line-height:25px;background:#dad5cb;border:0}.dg li.save-row select{margin-left:5px;width:108px}.dg li.save-row .button{margin-left:5px;margin-top:1px;border-radius:2px;font-size:9px;line-height:7px;padding:4px 4px 5px 4px;background:#c5bdad;color:#fff;text-shadow:0 1px 0 #b0a58f;box-shadow:0 -1px 0 #b0a58f;cursor:pointer}.dg li.save-row .button.gears{background:#c5bdad url(data:image/png;base64,) 2px 1px no-repeat;height:7px;width:8px}.dg li.save-row .button:hover{background-color:#bab19e;box-shadow:0 -1px 0 #b0a58f}.dg li.folder{border-bottom:0}.dg li.title{padding-left:16px;background:#000 url(data:image/gif;base64,R0lGODlhBQAFAJEAAP////Pz8////////yH5BAEAAAIALAAAAAAFAAUAAAIIlI+hKgFxoCgAOw==) 6px 10px no-repeat;cursor:pointer;border-bottom:1px solid rgba(255,255,255,0.2)}.dg .closed li.title{background-image:url(data:image/gif;base64,R0lGODlhBQAFAJEAAP////Pz8////////yH5BAEAAAIALAAAAAAFAAUAAAIIlGIWqMCbWAEAOw==)}.dg .cr.boolean{border-left:3px solid #806787}.dg .cr.color{border-left:3px solid}.dg .cr.function{border-left:3px solid #e61d5f}.dg .cr.number{border-left:3px solid #2FA1D6}.dg .cr.number input[type=text]{color:#2FA1D6}.dg .cr.string{border-left:3px solid #1ed36f}.dg .cr.string input[type=text]{color:#1ed36f}.dg .cr.function:hover,.dg .cr.boolean:hover{background:#111}.dg .c input[type=text]{background:#303030;outline:none}.dg .c input[type=text]:hover{background:#3c3c3c}.dg .c input[type=text]:focus{background:#494949;color:#fff}.dg .c .slider{background:#303030;cursor:ew-resize}.dg .c .slider-fg{background:#2FA1D6;max-width:100%}.dg .c .slider:hover{background:#3c3c3c}.dg .c .slider:hover .slider-fg{background:#44abda}
`);zf.inject(jf);var Xa="dg",qa=72,Ka=20,nn="Default",Qt=function(){try{return!!window.localStorage}catch{return!1}}(),en=void 0,Za=!0,It=void 0,di=!1,is=[],j=function t(e){var n=this,r=e||{};this.domElement=document.createElement("div"),this.__ul=document.createElement("ul"),this.domElement.appendChild(this.__ul),p.addClass(this.domElement,Xa),this.__folders={},this.__controllers=[],this.__rememberedObjects=[],this.__rememberedObjectIndecesToControllers=[],this.__listening=[],r=h.defaults(r,{closeOnTop:!1,autoPlace:!0,width:t.DEFAULT_WIDTH}),r=h.defaults(r,{resizable:r.autoPlace,hideable:r.autoPlace}),h.isUndefined(r.load)?r.load={preset:nn}:r.preset&&(r.load.preset=r.preset),h.isUndefined(r.parent)&&r.hideable&&is.push(this),r.resizable=h.isUndefined(r.parent)&&r.resizable,r.autoPlace&&h.isUndefined(r.scrollable)&&(r.scrollable=!0);var i=Qt&&localStorage.getItem(Ct(this,"isLocal"))==="true",o=void 0,a=void 0;if(Object.defineProperties(this,{parent:{get:function(){return r.parent}},scrollable:{get:function(){return r.scrollable}},autoPlace:{get:function(){return r.autoPlace}},closeOnTop:{get:function(){return r.closeOnTop}},preset:{get:function(){return n.parent?n.getRoot().preset:r.load.preset},set:function(m){n.parent?n.getRoot().preset=m:r.load.preset=m,Kf(this),n.revert()}},width:{get:function(){return r.width},set:function(m){r.width=m,xi(n,m)}},name:{get:function(){return r.name},set:function(m){r.name=m,a&&(a.innerHTML=r.name)}},closed:{get:function(){return r.closed},set:function(m){r.closed=m,r.closed?p.addClass(n.__ul,t.CLASS_CLOSED):p.removeClass(n.__ul,t.CLASS_CLOSED),this.onResize(),n.__closeButton&&(n.__closeButton.innerHTML=m?t.TEXT_OPEN:t.TEXT_CLOSED)}},load:{get:function(){return r.load}},useLocalStorage:{get:function(){return i},set:function(m){Qt&&(i=m,m?p.bind(window,"unload",o):p.unbind(window,"unload",o),localStorage.setItem(Ct(n,"isLocal"),m))}}}),h.isUndefined(r.parent)){if(this.closed=r.closed||!1,p.addClass(this.domElement,t.CLASS_MAIN),p.makeSelectable(this.domElement,!1),Qt&&i){n.useLocalStorage=!0;var s=localStorage.getItem(Ct(this,"gui"));s&&(r.load=JSON.parse(s))}this.__closeButton=document.createElement("div"),this.__closeButton.innerHTML=t.TEXT_CLOSED,p.addClass(this.__closeButton,t.CLASS_CLOSE_BUTTON),r.closeOnTop?(p.addClass(this.__closeButton,t.CLASS_CLOSE_TOP),this.domElement.insertBefore(this.__closeButton,this.domElement.childNodes[0])):(p.addClass(this.__closeButton,t.CLASS_CLOSE_BOTTOM),this.domElement.appendChild(this.__closeButton)),p.bind(this.__closeButton,"click",function(){n.closed=!n.closed})}else{r.closed===void 0&&(r.closed=!0);var l=document.createTextNode(r.name);p.addClass(l,"controller-name"),a=bi(n,l);var c=function(m){return m.preventDefault(),n.closed=!n.closed,!1};p.addClass(this.__ul,t.CLASS_CLOSED),p.addClass(a,"title"),p.bind(a,"click",c),r.closed||(this.closed=!1)}r.autoPlace&&(h.isUndefined(r.parent)&&(Za&&(It=document.createElement("div"),p.addClass(It,Xa),p.addClass(It,t.CLASS_AUTO_PLACE_CONTAINER),document.body.appendChild(It),Za=!1),It.appendChild(this.domElement),p.addClass(this.domElement,t.CLASS_AUTO_PLACE)),this.parent||xi(n,r.width)),this.__resizeHandler=function(){n.onResizeDebounced()},p.bind(window,"resize",this.__resizeHandler),p.bind(this.__ul,"webkitTransitionEnd",this.__resizeHandler),p.bind(this.__ul,"transitionend",this.__resizeHandler),p.bind(this.__ul,"oTransitionEnd",this.__resizeHandler),this.onResize(),r.resizable&&qf(this),o=function(){Qt&&localStorage.getItem(Ct(n,"isLocal"))==="true"&&localStorage.setItem(Ct(n,"gui"),JSON.stringify(n.getSaveObject()))},this.saveToLocalStorageIfPossible=o;function d(){var f=n.getRoot();f.width+=1,h.defer(function(){f.width-=1})}r.parent||d()};j.toggleHide=function(){di=!di,h.each(is,function(t){t.domElement.style.display=di?"none":""})};j.CLASS_AUTO_PLACE="a";j.CLASS_AUTO_PLACE_CONTAINER="ac";j.CLASS_MAIN="main";j.CLASS_CONTROLLER_ROW="cr";j.CLASS_TOO_TALL="taller-than-window";j.CLASS_CLOSED="closed";j.CLASS_CLOSE_BUTTON="close-button";j.CLASS_CLOSE_TOP="close-top";j.CLASS_CLOSE_BOTTOM="close-bottom";j.CLASS_DRAG="drag";j.DEFAULT_WIDTH=245;j.TEXT_CLOSED="Close Controls";j.TEXT_OPEN="Open Controls";j._keydownHandler=function(t){document.activeElement.type!=="text"&&(t.which===qa||t.keyCode===qa)&&j.toggleHide()};p.bind(window,"keydown",j._keydownHandler,!1);h.extend(j.prototype,{add:function(e,n){return tn(this,e,n,{factoryArgs:Array.prototype.slice.call(arguments,2)})},addColor:function(e,n){return tn(this,e,n,{color:!0})},remove:function(e){this.__ul.removeChild(e.__li),this.__controllers.splice(this.__controllers.indexOf(e),1);var n=this;h.defer(function(){n.onResize()})},destroy:function(){if(this.parent)throw new Error("Only the root GUI should be removed with .destroy(). For subfolders, use gui.removeFolder(folder) instead.");this.autoPlace&&It.removeChild(this.domElement);var e=this;h.each(this.__folders,function(n){e.removeFolder(n)}),p.unbind(window,"keydown",j._keydownHandler,!1),Ja(this)},addFolder:function(e){if(this.__folders[e]!==void 0)throw new Error('You already have a folder in this GUI by the name "'+e+'"');var n={name:e,parent:this};n.autoPlace=this.autoPlace,this.load&&this.load.folders&&this.load.folders[e]&&(n.closed=this.load.folders[e].closed,n.load=this.load.folders[e]);var r=new j(n);this.__folders[e]=r;var i=bi(this,r.domElement);return p.addClass(i,"folder"),r},removeFolder:function(e){this.__ul.removeChild(e.domElement.parentElement),delete this.__folders[e.name],this.load&&this.load.folders&&this.load.folders[e.name]&&delete this.load.folders[e.name],Ja(e);var n=this;h.each(e.__folders,function(r){e.removeFolder(r)}),h.defer(function(){n.onResize()})},open:function(){this.closed=!1},close:function(){this.closed=!0},hide:function(){this.domElement.style.display="none"},show:function(){this.domElement.style.display=""},onResize:function(){var e=this.getRoot();if(e.scrollable){var n=p.getOffset(e.__ul).top,r=0;h.each(e.__ul.childNodes,function(i){e.autoPlace&&i===e.__save_row||(r+=p.getHeight(i))}),window.innerHeight-n-Ka<r?(p.addClass(e.domElement,j.CLASS_TOO_TALL),e.__ul.style.height=window.innerHeight-n-Ka+"px"):(p.removeClass(e.domElement,j.CLASS_TOO_TALL),e.__ul.style.height="auto")}e.__resize_handle&&h.defer(function(){e.__resize_handle.style.height=e.__ul.offsetHeight+"px"}),e.__closeButton&&(e.__closeButton.style.width=e.width+"px")},onResizeDebounced:h.debounce(function(){this.onResize()},50),remember:function(){if(h.isUndefined(en)&&(en=new Wf,en.domElement.innerHTML=kf),this.parent)throw new Error("You can only call remember on a top level GUI.");var e=this;h.each(Array.prototype.slice.call(arguments),function(n){e.__rememberedObjects.length===0&&Xf(e),e.__rememberedObjects.indexOf(n)===-1&&e.__rememberedObjects.push(n)}),this.autoPlace&&xi(this,this.width)},getRoot:function(){for(var e=this;e.parent;)e=e.parent;return e},getSaveObject:function(){var e=this.load;return e.closed=this.closed,this.__rememberedObjects.length>0&&(e.preset=this.preset,e.remembered||(e.remembered={}),e.remembered[this.preset]=lr(this)),e.folders={},h.each(this.__folders,function(n,r){e.folders[r]=n.getSaveObject()}),e},save:function(){this.load.remembered||(this.load.remembered={}),this.load.remembered[this.preset]=lr(this),gi(this,!1),this.saveToLocalStorageIfPossible()},saveAs:function(e){this.load.remembered||(this.load.remembered={},this.load.remembered[nn]=lr(this,!0)),this.load.remembered[e]=lr(this),this.preset=e,_i(this,e,!0),this.saveToLocalStorageIfPossible()},revert:function(e){h.each(this.__controllers,function(n){this.getRoot().load.remembered?os(e||this.getRoot(),n):n.setValue(n.initialValue),n.__onFinishChange&&n.__onFinishChange.call(n,n.getValue())},this),h.each(this.__folders,function(n){n.revert(n)}),e||gi(this.getRoot(),!1)},listen:function(e){var n=this.__listening.length===0;this.__listening.push(e),n&&as(this.__listening)},updateDisplay:function(){h.each(this.__controllers,function(e){e.updateDisplay()}),h.each(this.__folders,function(e){e.updateDisplay()})}});function bi(t,e,n){var r=document.createElement("li");return e&&r.appendChild(e),n?t.__ul.insertBefore(r,n):t.__ul.appendChild(r),t.onResize(),r}function Ja(t){p.unbind(window,"resize",t.__resizeHandler),t.saveToLocalStorageIfPossible&&p.unbind(window,"unload",t.saveToLocalStorageIfPossible)}function gi(t,e){var n=t.__preset_select[t.__preset_select.selectedIndex];e?n.innerHTML=n.value+"*":n.innerHTML=n.value}function Yf(t,e,n){if(n.__li=e,n.__gui=t,h.extend(n,{options:function(a){if(arguments.length>1){var s=n.__li.nextElementSibling;return n.remove(),tn(t,n.object,n.property,{before:s,factoryArgs:[h.toArray(arguments)]})}if(h.isArray(a)||h.isObject(a)){var l=n.__li.nextElementSibling;return n.remove(),tn(t,n.object,n.property,{before:l,factoryArgs:[a]})}},name:function(a){return n.__li.firstElementChild.firstElementChild.innerHTML=a,n},listen:function(){return n.__gui.listen(n),n},remove:function(){return n.__gui.remove(n),n}}),n instanceof mi){var r=new ur(n.object,n.property,{min:n.__min,max:n.__max,step:n.__step});h.each(["updateDisplay","onChange","onFinishChange","step","min","max"],function(o){var a=n[o],s=r[o];n[o]=r[o]=function(){var l=Array.prototype.slice.call(arguments);return s.apply(r,l),a.apply(n,l)}}),p.addClass(e,"has-slider"),n.domElement.insertBefore(r.domElement,n.domElement.firstElementChild)}else if(n instanceof ur){var i=function(a){if(h.isNumber(n.__min)&&h.isNumber(n.__max)){var s=n.__li.firstElementChild.firstElementChild.innerHTML,l=n.__gui.__listening.indexOf(n)>-1;n.remove();var c=tn(t,n.object,n.property,{before:n.__li.nextElementSibling,factoryArgs:[n.__min,n.__max,n.__step]});return c.name(s),l&&c.listen(),c}return a};n.min=h.compose(i,n.min),n.max=h.compose(i,n.max)}else n instanceof ts?(p.bind(e,"click",function(){p.fakeEvent(n.__checkbox,"click")}),p.bind(n.__checkbox,"click",function(o){o.stopPropagation()})):n instanceof rs?(p.bind(e,"click",function(){p.fakeEvent(n.__button,"click")}),p.bind(e,"mouseover",function(){p.addClass(n.__button,"hover")}),p.bind(e,"mouseout",function(){p.removeClass(n.__button,"hover")})):n instanceof hi&&(p.addClass(e,"color"),n.updateDisplay=h.compose(function(o){return e.style.borderLeftColor=n.__color.toString(),o},n.updateDisplay),n.updateDisplay());n.setValue=h.compose(function(o){return t.getRoot().__preset_select&&n.isModified()&&gi(t.getRoot(),!0),o},n.setValue)}function os(t,e){var n=t.getRoot(),r=n.__rememberedObjects.indexOf(e.object);if(r!==-1){var i=n.__rememberedObjectIndecesToControllers[r];if(i===void 0&&(i={},n.__rememberedObjectIndecesToControllers[r]=i),i[e.property]=e,n.load&&n.load.remembered){var o=n.load.remembered,a=void 0;if(o[t.preset])a=o[t.preset];else if(o[nn])a=o[nn];else return;if(a[r]&&a[r][e.property]!==void 0){var s=a[r][e.property];e.initialValue=s,e.setValue(s)}}}}function tn(t,e,n,r){if(e[n]===void 0)throw new Error('Object "'+e+'" has no property "'+n+'"');var i=void 0;if(r.color)i=new hi(e,n);else{var o=[e,n].concat(r.factoryArgs);i=Vf.apply(t,o)}r.before instanceof ft&&(r.before=r.before.__li),os(t,i),p.addClass(i.domElement,"c");var a=document.createElement("span");p.addClass(a,"property-name"),a.innerHTML=i.property;var s=document.createElement("div");s.appendChild(a),s.appendChild(i.domElement);var l=bi(t,s,r.before);return p.addClass(l,j.CLASS_CONTROLLER_ROW),i instanceof hi?p.addClass(l,"color"):p.addClass(l,Rf(i.getValue())),Yf(t,l,i),t.__controllers.push(i),i}function Ct(t,e){return document.location.href+"."+e}function _i(t,e,n){var r=document.createElement("option");r.innerHTML=e,r.value=e,t.__preset_select.appendChild(r),n&&(t.__preset_select.selectedIndex=t.__preset_select.length-1)}function Qa(t,e){e.style.display=t.useLocalStorage?"block":"none"}function Xf(t){var e=t.__save_row=document.createElement("li");p.addClass(t.domElement,"has-save"),t.__ul.insertBefore(e,t.__ul.firstChild),p.addClass(e,"save-row");var n=document.createElement("span");n.innerHTML="&nbsp;",p.addClass(n,"button gears");var r=document.createElement("span");r.innerHTML="Save",p.addClass(r,"button"),p.addClass(r,"save");var i=document.createElement("span");i.innerHTML="New",p.addClass(i,"button"),p.addClass(i,"save-as");var o=document.createElement("span");o.innerHTML="Revert",p.addClass(o,"button"),p.addClass(o,"revert");var a=t.__preset_select=document.createElement("select");if(t.load&&t.load.remembered?h.each(t.load.remembered,function(f,m){_i(t,m,m===t.preset)}):_i(t,nn,!1),p.bind(a,"change",function(){for(var f=0;f<t.__preset_select.length;f++)t.__preset_select[f].innerHTML=t.__preset_select[f].value;t.preset=this.value}),e.appendChild(a),e.appendChild(n),e.appendChild(r),e.appendChild(i),e.appendChild(o),Qt){var s=document.getElementById("dg-local-explain"),l=document.getElementById("dg-local-storage"),c=document.getElementById("dg-save-locally");c.style.display="block",localStorage.getItem(Ct(t,"isLocal"))==="true"&&l.setAttribute("checked","checked"),Qa(t,s),p.bind(l,"change",function(){t.useLocalStorage=!t.useLocalStorage,Qa(t,s)})}var d=document.getElementById("dg-new-constructor");p.bind(d,"keydown",function(f){f.metaKey&&(f.which===67||f.keyCode===67)&&en.hide()}),p.bind(n,"click",function(){d.innerHTML=JSON.stringify(t.getSaveObject(),void 0,2),en.show(),d.focus(),d.select()}),p.bind(r,"click",function(){t.save()}),p.bind(i,"click",function(){var f=prompt("Enter a new preset name.");f&&t.saveAs(f)}),p.bind(o,"click",function(){t.revert()})}function qf(t){var e=void 0;t.__resize_handle=document.createElement("div"),h.extend(t.__resize_handle.style,{width:"6px",marginLeft:"-3px",height:"200px",cursor:"ew-resize",position:"absolute"});function n(o){return o.preventDefault(),t.width+=e-o.clientX,t.onResize(),e=o.clientX,!1}function r(){p.removeClass(t.__closeButton,j.CLASS_DRAG),p.unbind(window,"mousemove",n),p.unbind(window,"mouseup",r)}function i(o){return o.preventDefault(),e=o.clientX,p.addClass(t.__closeButton,j.CLASS_DRAG),p.bind(window,"mousemove",n),p.bind(window,"mouseup",r),!1}p.bind(t.__resize_handle,"mousedown",i),p.bind(t.__closeButton,"mousedown",i),t.domElement.insertBefore(t.__resize_handle,t.domElement.firstElementChild)}function xi(t,e){t.domElement.style.width=e+"px",t.__save_row&&t.autoPlace&&(t.__save_row.style.width=e+"px"),t.__closeButton&&(t.__closeButton.style.width=e+"px")}function lr(t,e){var n={};return h.each(t.__rememberedObjects,function(r,i){var o={},a=t.__rememberedObjectIndecesToControllers[i];h.each(a,function(s,l){o[l]=e?s.initialValue:s.getValue()}),n[i]=o}),n}function Kf(t){for(var e=0;e<t.__preset_select.length;e++)t.__preset_select[e].value===t.preset&&(t.__preset_select.selectedIndex=e)}function as(t){t.length!==0&&$f.call(window,function(){as(t)}),h.each(t,function(e){e.updateDisplay()})}var ss=j;function ls(t,e,n,r){let i=new ss,o={openGithub:()=>{window.location.href=u.githubRepoLink},profile:()=>{e.profileNextFrame(!0)},resetCamera:()=>{r.resetPosition()},resetSimulation:()=>{u.hairSimulation.nextFrameResetSimulation=!0},resetBall:()=>{K.copy(u.hairSimulation.collisionSphereInitial,u.hairSimulation.collisionSphere)},modelRotation:0};i.add(o,"openGithub").name("GITHUB"),i.add(o,"profile").name("Profile");let a=Pi(u,"displayMode",[{label:"Final",value:A.FINAL},{label:"DBG: tiles",value:A.TILES},{label:"DBG: tiles PPLL",value:A.TILES_PPLL},{label:"DBG: slices cnt",value:A.USED_SLICES},{label:"DBG: hw-render",value:A.HW_RENDER},{label:"DBG: depth",value:A.DEPTH},{label:"DBG: normals",value:A.NORMALS},{label:"DBG: ao",value:A.AO}]),s=i.add(a,"displayMode",a.values).name("Display mode");l(i),c(i),d(i),f(i),m(i),v(i,u.lights[0],"Light 0"),v(i,u.lights[1],"Light 1"),v(i,u.lights[2],"Light 2"),b(i),x(i),g();function l(P){let _=P.addFolder("Scene"),S=u.background;_.add(o,"resetCamera").name("Reset camera"),_.add(o,"modelRotation",0,360).step(1).name("Rotation").onChange(E=>{M.rotationY(Ae(E),n.modelMatrix)}),T(_,S,"color0","Bg color 0"),T(_,S,"color1","Bg color 1"),_.add(S,"noiseScale",0,10).name("Bg noise scale"),_.add(S,"gradientStrength",0,1).name("Bg gradient")}function c(P){let _=u.hairRender,S=P.addFolder("Hair render");S.open(),S.add(_,"lodRenderPercent",0,100).step(1).name("Render %"),S.add(_,"fiberRadius",1e-4,.002).name("Radius");let E=S.add(_,"dbgTileModeMaxSegments",1,512).step(1).name("Max segments"),N=S.add(_,"dbgSlicesModeMaxSlices",1,128).step(1).name("Max slices"),R=S.add(_,"dbgShowTiles").name("Show tiles");s.onFinishChange(V);function V(){let w=u.displayMode;wi(E,w===A.TILES||w===A.TILES_PPLL),wi(N,w===A.USED_SLICES),wi(R,w===A.FINAL)}}function d(P){let _=u.hairRender.material,S=P.addFolder("Hair material");T(S,_,"color0","Color root"),T(S,_,"color1","Color tip"),S.add(_,"colorRng",0,1).name("Color RNG"),S.add(_,"lumaRng",0,1).name("Luma RNG"),S.add(_,"specular",0,3,.01).name("Specular"),S.add(_,"weightTT",0,2,.01).name("Weight TT"),S.add(_,"weightTRT",0,2,.01).name("Weight TRT"),S.add(_,"shift",-1,1,.01).name("Shift"),S.add(_,"roughness",0,1,.01).name("Roughness"),S.add(_,"attenuation",0,40).name("Attenuation"),S.add(_,"shadows",0,1).name("Shadows")}function f(P){let _=u.hairSimulation,S=_.sdf,E=_.physicsForcesGrid,N=_.constraints,R=_.wind,V=P.addFolder("Hair simulation"),w=V;w.open(),w.add(o,"resetSimulation").name("Reset simulation"),w.add(_,"enabled").name("Enabled"),w.add(_,"gravity",0,.1).name("Gravity"),w.add(_,"friction",0,1).name("Friction"),w.add(_,"volumePreservation",0,25e-5).name("Vol. Preserv."),w.add(o,"resetBall").name("Reset ball"),w.add(u,"drawColliders").name("Draw ball"),w=V.addFolder("Constraints"),w.open(),w.add(N,"constraintIterations",1,10).step(1).name("Iterations"),w.add(N,"stiffnessLengthConstr",0,1).name("Stiff. len"),w.add(N,"stiffnessGlobalConstr",0,1).name("Stiff. global"),w.add(N,"globalExtent",0,1).name("Global extent"),w.add(N,"globalFade",0,1).name("Global fade"),w.add(N,"stiffnessLocalConstr",0,1).name("Stiff. local"),w.add(N,"stiffnessCollisions",0,1).name("Stiff. collisions"),w.add(N,"stiffnessSDF",0,1).name("Stiff. SDF"),w.add(S,"distanceOffset",-.003,.003).name("SDF offset"),w=V.addFolder("Wind"),w.open(),w.add(R,"dirPhi",-179,179).step(1).name("Dir phi"),w.add(R,"dirTheta",15,165).step(1).name("Dir th"),w.add(R,"strength",0,1).name("Strength"),w.add(R,"strengthLull",0,1).name("Lull strength"),w.add(R,"strengthFrequency",.001,2).name("Str. frequency"),w.add(R,"strengthJitter",0,1).name("Str. Jitter"),w.add(R,"phaseOffset",0,.5).name("Phase offset"),w.add(R,"colisionTraceOffset",1,5).name("Collision offset"),w=V.addFolder("SDF preview"),w.add(S,"showDebugView").name("Enabled"),w.add(S,"debugSemitransparent").name("Semitransparent"),w.add(S,"debugSlice",0,1,.01).name("Slice"),w=V.addFolder("Grids preview"),w.add(E,"showDebugView").name("Enabled");let Q=Pi(E,"debugValue",[{label:"Density",value:xe.DENSITY},{label:"Density Grad",value:xe.DENSITY_GRADIENT},{label:"Velocity",value:xe.VELOCITY},{label:"Wind",value:xe.WIND}]);w.add(Q,"debugValue",Q.values).name("Value"),w.add(E,"debugAbsValue").name("Vector abs"),w.add(E,"debugSlice",0,1,.01).name("Slice")}function m(P){let _=P.addFolder("Ambient light");T(_,u.lightAmbient,"color","Color"),_.add(u.lightAmbient,"energy",0,.2,.01).name("Energy")}function v(P,_,S){let E=P.addFolder(S);E.add(_,"posPhi",-179,179).step(1).name("Position phi"),E.add(_,"posTheta",15,165).step(1).name("Position th"),T(E,_,"color","Color"),E.add(_,"energy",0,2).name("Energy")}function b(P){let _=u.shadows,S=P.addFolder("Shadows"),E=Pi(_,"usePCSS",[{label:"PCF",value:!1},{label:"PCSS",value:!0}]);S.add(E,"usePCSS",E.values).name("Technique"),S.add(_,"strength",0,1).name("Strength"),S.add(_,"PCF_Radius",[0,1,2,3,4]).name("PCF radius"),S.add(_,"bias",0,.001).name("Bias"),S.add(_,"hairFiberWidthMultiplier",.5,6).name("Hair width mul"),S.add(_.source,"posPhi",-179,179).step(1).name("Position phi"),S.add(_.source,"posTheta",15,165).step(1).name("Position th"),S.add(_,"showDebugView").name("Show preview")}function x(P){let _=u.ao,S=P.addFolder("Ambient occl.");S.add(_,"strength",0,1).name("Strength"),S.add(_,"radius",.001,2.5).name("Radius"),S.add(_,"numDirections",0,128,1).name("Directions"),S.add(_,"numSteps",2,32,1).name("Steps"),S.add(_,"directionOffset",0,5).name("Dir. offset"),S.add(_,"falloffStart2",0,.5).name("Falloff start"),S.add(_,"falloffEnd2",1,5).name("Falloff end")}function g(){let P=i.addFolder("Color mgmt"),_=u.colors;P.add(_,"gamma",1,3).name("Gamma"),P.add(_,"exposure",0,2).name("Exposure"),P.add(_,"ditherStrength",0,2).name("Dithering")}function T(P,_,S,E){let N={value:[]};Object.defineProperty(N,"value",{enumerable:!0,get:()=>{let R=_[S];return[R[0]*255,R[1]*255,R[2]*255]},set:R=>{let V=_[S];V[0]=R[0]/255,V[1]=R[1]/255,V[2]=R[2]/255}}),P.addColor(N,"value").name(E)}}function wi(t,e){if(!t){console.error("Not controller for gui element found!");return}let n=t.__li;e?n.style.display="":n.style.display="none"}var Pi=(t,e,n)=>{let r={values:n.map(i=>i.label)};return Object.defineProperty(r,e,{enumerable:!0,get:()=>{let i=t[e];return(n.find(a=>a.value===i)||n[0]).label},set:i=>{let o=n.find(a=>a.label===i)||n[0];t[e]=o.value}}),r};function cs(t,e){let n=l();t.width=n.width,t.height=n.height,console.log("Init canvas size:",n);let r=[];return{revalidateCanvasSize:a,addListener:c=>r.push(c),getViewportSize:l,getScreenTextureView:()=>e.getCurrentTexture().createView()};function a(){let c=l();(c.width!==t.width||c.height!==t.height)&&c.width&&c.height&&s(c)}function s(c){t.width=c.width,t.height=c.height,r.forEach(d=>d(c))}function l(){let c=window.devicePixelRatio||1;return fn({width:t.clientWidth*c,height:t.clientHeight*c})}}function us(t){let e=["internal","out-of-memory","validation"],n=e.toReversed(),r="-";return{startErrorScope:i,reportErrorScopeAsync:o};function i(a="-"){r=a,e.forEach(s=>t.pushErrorScope(s))}async function o(a){let s;for(let l of n){let c=await t.popErrorScope();if(c){let d=`WebGPU error [${r}][${l}]: ${c.message}`;s=d,a?a(d):console.error(d)}}return s}}var fs=t=>t=="0"?"1":"0",fr=class{constructor(e,n,r,i,o){this.name=e;this.strandsCount=n;this.pointsPerStrand=r;this.bounds=i;this.buffers=o}_currentPositionsBuffer="0";get pointsCount(){return this.strandsCount*this.pointsPerStrand}get segmentCount(){return this.strandsCount*(this.pointsPerStrand-1)}get currentPositionsBufferIdx(){return this._currentPositionsBuffer}getRenderedStrandCount(){let e=Rt(u.hairRender.lodRenderPercent,0,100),{strandsCount:n}=this,r=Math.ceil(n*e/100);return Rt(r,0,n)}reportRenderedStrandCount(){let{strandsCount:e,pointsPerStrand:n,segmentCount:r}=this,i=this.getRenderedStrandCount();k.update("Rendered strands",vr(i,e,0));let o=i*(n-1);return k.update("Rendered segments",vr(o,r,0)),i}resetSimulation(e){let{initialPointsPositionsBuffer:n,pointsPositionsBuffer_0:r,pointsPositionsBuffer_1:i}=this.buffers,o=n.size;e.copyBufferToBuffer(n,0,r,0,o),e.copyBufferToBuffer(n,0,i,0,o)}swapPositionBuffersAfterSimIntegration(){this._currentPositionsBuffer=fs(this._currentPositionsBuffer)}bindPointsPositions=e=>this.bindPointsPositionsByPosIdx(e,this._currentPositionsBuffer);bindPointsPositions_PREV=e=>this.bindPointsPositionsByPosIdx(e,fs(this._currentPositionsBuffer));bindPointsPositionsByPosIdx=(e,n)=>{let r=n=="0"?this.buffers.pointsPositionsBuffer_0:this.buffers.pointsPositionsBuffer_1;return{binding:e,resource:{buffer:r}}};bindTangents=e=>L(e,this.buffers.tangentsBuffer);bindPointsPositions_INITIAL=e=>L(e,this.buffers.initialPointsPositionsBuffer);bindInitialSegmentLengths=e=>L(e,this.buffers.initialSegmentLengthsBuffer);bindHairData=e=>L(e,this.buffers.dataBuffer);bindShading=e=>L(e,this.buffers.shadingBuffer);bindIndexBuffer(e){e.setIndexBuffer(this.buffers.indicesData.indexBuffer,this.buffers.indicesData.indexFormat)}};var Jf=t=>{let e=new Float32Array(t,0,1)[0],n=new Uint32Array(t,4,7);return{version:e,numHairStrands:n[0],numVerticesPerStrand:n[1],offsetVertexPosition:n[2],offsetStrandUV:n[3],offsetVertexUV:n[4],offsetStrandThickness:n[5],offsetVertexColor:n[6]}},ds=(t,e)=>{let n=Jf(t);console.log("Loaded Tfx file with header",n);let i=n.numHairStrands*n.numVerticesPerStrand*4,a=new Float32Array(t,n.offsetVertexPosition,i).map(s=>s*e);return{header:n,vertexPositions:a}};var dr=Fs(ps());var Qf=dr.default?.Mesh||dr.Mesh,ms=t=>Math.ceil(t.vertices.length/3),ed=t=>Math.ceil(t.indices.length/3);function hs(t,e,n,r=1){let i=new Qf(n);rd(i,r);let o=ms(i),a=ed(i),s=Ot(Float32Array,i.vertices),l=vn(t,`${e}-positions`,s),c=vn(t,`${e}-normals`,i.vertexNormals),d=vn(t,`${e}-uvs`,i.textures),f=bn(t,`${e}-indices`,i.indices),m=ko(s);return console.log(`Loaded OBJ object '${e}', bounds`,m.sphere),{name:e,vertexCount:o,triangleCount:a,positionsBuffer:l,normalsBuffer:c,uvBuffer:d,indexBuffer:f,bounds:m,isColliderPreview:!1}}var td=t=>{if(!t.vertexNormals||!Array.isArray(t.vertexNormals))return!1;let e=t.vertexNormals[0];return typeof e=="number"&&!isNaN(e)},nd=t=>{if(!t.textures||!Array.isArray(t.textures))return!1;let e=t.textures[0];return typeof e=="number"&&!isNaN(e)};function rd(t,e){if(t.vertices=t.vertices.map(n=>n*e),!td(t))throw new Error("Expected normals in the OBJ file");if(nd(t))for(let n=0;n<t.textures.length;n+=1){let r=t.textures[n];r=r%1,r=r<0?1-Math.abs(r):r,r=(n&1)==1?1-r:r,t.textures[n]=r}else{let n=ms(t);t.textures=Ye(n*2).fill(.5)}}var id="r32float";function gs(t,e,n,r){let i={width:n,height:n,depthOrArrayLayers:n},o=t.createTexture({label:`${e}-texture`,dimension:"3d",size:i,format:id,usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST});return t.queue.writeTexture({texture:o},r,{bytesPerRow:Te*n,rowsPerImage:n},i),o}function _s(t,e){return t.createSampler({label:`${e}-sampler`,addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge",addressModeW:"clamp-to-edge",magFilter:"linear",minFilter:"linear"})}function xs(t,e,n){let r=new Uint32Array(n,0,1)[0],i=2,o=new Float32Array(n),a=[[o[i+0],o[i+1],o[i+2]],[o[i+3],o[i+4],o[i+5]]];i+=6;let s=o.slice(i),l=r*r*r;if(s.length!==l)throw new Error(`Invalid SDF binary file. With dims=${r} expected ${l} values. Got ${s.length}.`);let c=gs(t,e,r,s),d=c.createView(),f=_s(t,e);return new se(e,a,r,c,d,f)}var od=[{name:"sintel",file:"sintel.obj"},{name:"sintelEyes",file:"sintel-eyes.obj"},{name:"sphereCollider",file:"sphere.obj",isColliderPreview:!0}],Ss={name:"sintel-sdf",file:"sintel-sdf.bin"};async function vs(t){let e=[];for(let l of od){console.groupCollapsed(l.name);let c=await u.loaders.textFileReader(`${mn}/${l.file}`),d=hs(t,l.name,c);d.isColliderPreview=!!l.isColliderPreview,e.push(d),console.groupEnd()}K.copy(u.hairSimulation.collisionSphere,u.hairSimulation.collisionSphereInitial);let n=await sd(u.hairFile,1),r=await ad(t,"sintelHair",n);u.pointsPerStrand=r.pointsPerStrand,k.update("Strands",Sn(r.strandsCount,1)),k.update("Points per strand",r.pointsPerStrand),k.update("Segments",Sn(r.segmentCount,0));let i=await u.loaders.binaryFileReader(`${mn}/${Ss.file}`),o=xs(t,Ss.name,i),a=new Oe(t,r.bounds.box),s=M.identity();return M.rotateY(s,Ae(0),s),{objects:e,hairObject:r,sdfCollider:o,modelMatrix:s,physicsGrid:a}}function ad(t,e,n){let r=Ur(n.vertexPositions,4),i={box:r,sphere:zr(r)};console.log("Hair bounds",i.sphere);let o=ra(t,e,n,i.sphere),a=sa(t,e,n),s=aa(t,e,n),l=na(t,e,n),c=Aa(t,e,n.header.numVerticesPerStrand,n.vertexPositions),d=(b,x=0)=>oa(t,b,n.vertexPositions,x),f=d(`${e}-points-positions-initial`,GPUBufferUsage.COPY_SRC),m=d(`${e}-points-positions-0`),v=d(`${e}-points-positions-1`);return new fr(e,n.header.numHairStrands,n.header.numVerticesPerStrand,i,{dataBuffer:o,indicesData:l,initialPointsPositionsBuffer:f,initialSegmentLengthsBuffer:c,pointsPositionsBuffer_0:m,pointsPositionsBuffer_1:v,shadingBuffer:s,tangentsBuffer:a})}async function sd(t,e=1){console.log(`Loading hair file: '${t}'`);let n=await u.loaders.binaryFileReader(`${mn}/${t}`);return ds(n,e)}var ld=Tr.create(),bs=K.create(),yi=K.create(),cd=M.create(),ws=(t,e,n,r)=>{let i=Tr.set(n[0]/t.width,n[1]/t.height,ld);i[0]=i[0]*2-1,i[1]=(1-i[1])*2-1;let o=M.invert(e,cd),a=K.set(i[0],i[1],0,1,bs),s=K.set(i[0],i[1],1,1,yi),l=Gr(o,a,bs),c=Gr(o,s,yi);return y.copy(l,r.origin),y.normalize(y.subtract(c,l,yi),r.dir),r},Ti=(t,e,n)=>y.addScaled(t.origin,t.dir,e,n),Ei=(t,e,n)=>{let r=y.subtract(e,t.origin,n),i=y.dot(r,t.dir);return Ti(t,i,n)},ud=y.create(),it=(t,e)=>{let n=Ei(t,e,ud);return y.distance(e,n)},fd=y.create(),dd=y.create(),Ps=(t,e,n,r=5)=>{let i=y.copy(e,fd),o=y.copy(n,dd);for(let l=0;l<r;l++){let c=it(t,i),d=it(t,o);c<d?y.midpoint(i,o,o):y.midpoint(i,o,i)}let a=it(t,i),s=it(t,o);return a<s?i:o};var pd=y.create(),md=(t,e)=>{let n=e.d+y.dot(t.origin,e.normal,pd),r=y.dot(t.dir,e.normal);return-n/r},ys=(t,e,n)=>{let r=md(t,e);return Ti(t,r,n)};var hd=y.create(1,0,0),gd=y.create(0,1,0),_d=y.create(0,0,1),Mi=[hd,gd,_d],xd=[Ee.AXIS_X,Ee.AXIS_Y,Ee.AXIS_Z],Sd=u.colliderGizmo.lineLength*.1,vd=K.create(),bd=K.create(),wd=M.create(),Pd={origin:y.create(),dir:y.create()},Ii=t=>document.body.style.cursor=t;function Es(){let t=u.colliderGizmo,e=0;return function(n,r,i,o){let a=n.mouse.touching,s=[n.mouse.x,n.mouse.y],l=wn(i,o,wd),c=ws(r,l,s,Pd);if(t.isDragging)yd(c,e);else{let d=y.create(),f=Td(c,d);Ed(f);let m=u.hairSimulation.collisionSphere;e=y.distance(m,d),a&&(a=f!==Ee.NONE,Ii("grabbing"))}return t.isDragging=a,a}}function yd(t,e){let n=u.colliderGizmo,r=u.hairSimulation.collisionSphere,i=n.activeAxis,o={dir:Mi[i],origin:r},a={normal:t.dir,d:-y.dot(t.dir,r)},s=ys(t,a),l=Ei(o,s),c=e;l=y.addScaled(l,o.dir,-c),r[i]=l[i]}function Td(t,e){let{lineWidth:n,hoverPadding:r}=u.colliderGizmo,i=Number.MAX_SAFE_INTEGER,o=0;Mi.forEach((m,v)=>{let[b,x]=Ts(m),g=Math.min(it(t,b),it(t,x));g<i&&(i=g,o=v)});let a=Mi[o],[s,l]=Ts(a),c=Ps(t,s,l),d=it(t,c),f=n*r;return d<f?(y.copy(c,e),o):Ee.NONE}function Ed(t){t===Ee.NONE?(u.colliderGizmo.activeAxis=Ee.NONE,Ii("default")):(u.colliderGizmo.activeAxis=xd[t],Ii("grab"))}function Ts(t){let{lineLength:e}=u.colliderGizmo,n=u.hairSimulation.collisionSphere,r=y.addScaled(n,t,Sd,vd),i=y.addScaled(r,t,e,bd);return[r,i]}function Ms(t){console.log("Profiler:",t);let e=document.getElementById("profiler-results");e.innerHTML="",st(e.parentNode);let n={},r=new Set;t.forEach(([a,s])=>{let l=n[a]||0;n[a]=l+s,r.add(a)});let i=0;r.forEach(a=>{let s=n[a],l=document.createElement("li");l.innerHTML=`${a}: ${s.toFixed(2)}ms`,e.appendChild(l),i+=s});let o=document.createElement("li");o.innerHTML=`--- TOTAL: ${i.toFixed(2)}ms ---`,e.appendChild(o)}(async function(){globalThis._config=u;let t=await Ji();if(!t){pr();return}let e=us(t);e.startErrorScope("init");let n=navigator.gpu.getPreferredCanvasFormat(),[r,i]=Md("#gpu-canvas",t,n),o=cs(r,i),a=Qi(window,r),s=await vs(t),l=new _n(t),c=new ar(t,o.getViewportSize(),n,l);o.addListener(c.onCanvasResize),ls(t,l,s,c.cameraCtrl);let d=Es();k.show();let f=!1,m=await e.reportErrorScopeAsync();if(m){pr(m);return}if(e.startErrorScope("beforeFirstFrame"),c.beforeFirstFrame(s),m=await e.reportErrorScopeAsync(),m){pr(m);return}let v={label:"main-frame-cmd-buffer"},b=()=>{e.startErrorScope("frame"),k.onEndFrame(),k.onBeginFrame(),l.beginFrame();let g=k.deltaTimeMS*Hi;o.revalidateCanvasSize();let T=a();d(T,o.getViewportSize(),c.viewMatrix,c.projectionMat)||c.updateCamera(g,T);let _=t.createCommandEncoder(v),S=o.getScreenTextureView();c.cmdRender(_,s,S),l.endFrame(_),t.queue.submit([_.finish()]),l.scheduleRaportIfNeededAsync(Ms),f||(e.reportErrorScopeAsync(x),requestAnimationFrame(b))};requestAnimationFrame(b);function x(g){throw pr(g),f=!0,new Error(g)}})();function Md(t,e,n){let r=document.querySelector(t),i=r.getContext("webgpu");return i.configure({device:e,format:n,alphaMode:"premultiplied"}),[r,i]}function pr(t){xn(document.getElementById("gpu-canvas")),st(document.getElementById("no-webgpu"),"flex"),t&&(document.getElementById("error-msg").textContent=t)}})();
